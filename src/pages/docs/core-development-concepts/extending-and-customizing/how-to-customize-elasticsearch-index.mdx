...
* [common dynamic mapping for our system fields](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-elasticsearch/src/indexConfiguration/common.ts)
* [the base mapping configuration for all indexes](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-elasticsearch/src/indexConfiguration/base.ts)

Also, each of the applications has its own default plugin for the index:
* File Manager Files [plugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-file-manager-ddb-es/src/elasticsearch/indices/base.ts)
* Form Builder Forms and Submissions [plugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-form-builder-so-ddb-es/src/elasticsearch/indices/base.ts)
* Headless CMS Entries [plugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-headless-cms-ddb-es/src/elasticsearch/indices/base.ts)
* Page Builder Pages [plugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-page-builder-so-ddb-es/src/elasticsearch/indices/base.ts)

Each of those plugins define how the Elasticsearch index for that particular application will look like when it is created. The plugins use [the base mapping configuration](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-elasticsearch/src/indexConfiguration/base.ts).
...
To read on how to enable locale code in your existing project, created prior to 5.26.0, read [this](/docs/core-development-concepts/extending-and-customizing/how-to-change-elasticsearch-index-name-to-contain-locale) article.

## Available Plugins

### File Manager
For the File Manager Files we have the [FileElasticsearchIndexPlugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-file-manager-ddb-es/src/plugins/FileElasticsearchIndexPlugin.ts).

### Form Builder
For the Form Builder Forms and Submissions we have the [FormElasticsearchIndexPlugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-form-builder-so-ddb-es/src/plugins/FormElasticsearchIndexPlugin.ts).

### Headless CMS
For the Headless CMS Entries we have [CmsEntryElasticsearchIndexPlugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-headless-cms-ddb-es/src/plugins/CmsEntryElasticsearchIndexPlugin.ts).

### Page Builder
For the Page Builder Pages we have the [PageElasticsearchIndexPlugin](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-page-builder-so-ddb-es/src/plugins/definitions/PageElasticsearchIndexPlugin.ts).
...
You can see how the index name is created in [this](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-file-manager-ddb-es/src/configurations.ts) file.
...
You can see how the index name is created in [this](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-form-builder-so-ddb-es/src/configurations.ts) file.
...
You can see how the index name is created in [this](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-headless-cms-ddb-es/src/configurations.ts) file.
...
You can see how the index name is created in [this](https://github.com/webiny/webiny-js/blob/feat/elasticsearch/japanese-index-template/packages/api-page-builder-so-ddb-es/src/configurations.ts) file.
