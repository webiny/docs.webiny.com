...
If you just want to jump straight into the code, take a look at the [Securing Your Application](../../admin-area/new-app-tutorial/security) tutorials section.

</Alert>

<Alert type="warning" title="Important">

This article is a continuation of the previous two articles about Webiny Security Framework. If you haven't already, please do read the [Introduction](../../core-development-concepts/security-framework/introduction) and [API Security](../../core-development-concepts/security-framework/api-security) articles before continuing.
