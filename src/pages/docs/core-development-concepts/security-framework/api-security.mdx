...
This article uses terms like authentication, authorization, identity, and permissions extensively. These terms are described in details in the [Introduction](../../core-development-concepts/security-framework/introduction) article. If you're not familiar with these terms, make sure you read that article first.
