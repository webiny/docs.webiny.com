...
All of the mentioned tools (and some others) are already included and configured for you in every Webiny project. Check out the [Tools and Libraries](../../core-development-concepts/basics/tools-and-libraries) key topic to learn more.
...
Merging strategies are covered in the upcoming [Workflows](../../core-development-concepts/ci-cd/workflows) guide.
...
As mentioned in the previous [Points of Execution](../../core-development-concepts/ci-cd/testing#points-of-execution) section, tests can be run upon submitting PRs. And since integration and end-to-end (E2E) tests require cloud infrastructure resources to be deployed, we end up with a need to deploy our project into a short-lived, or sometimes also called an ephemeral, environment.
...
In some cases, doing this can [incur additional cost](../../core-development-concepts/ci-cd/environments#multiple-environments-and-extra-costs).
...
Read more about the preview command in the [Preview Deployments](../../infrastructure/basics/preview-deployments) guide.

</Alert>

#### Mark Mission Critical Cloud Infrastructure Resources As Protected

By default, Webiny uses [Pulumi](../../infrastructure/pulumi-iac/iac-with-pulumi) as the default infrastructure as code (IaC) framework, which allows us to mark one or more cloud infrastructure resources as [protected](https://www.pulumi.com/docs/intro/concepts/resources/#protect):
...
Learn more about the **API** project application in the [Cloud Infrastructure](../../architecture/api/introduction) key topics section.
