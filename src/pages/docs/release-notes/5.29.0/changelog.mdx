...
With this release, we're introducing a brand new project setup, which, we believe, will be huge step forward in making Webiny as easy to grasp and use as possible! 
