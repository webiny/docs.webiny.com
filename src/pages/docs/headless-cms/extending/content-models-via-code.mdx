...
Let's create a [`models.ts`](https://github.com/webiny/webiny-examples/blob/master/headless-cms/content-model-plugins/basic/api/code/headlessCMS/src/plugins/models.ts) file in the `api/code/headlessCMS/src/plugins` directory.
...
Let's make the following changes in `api/code/headlessCMS/src/index.ts` file:

```diff-js api/code/headlessCMS/src/index.ts
(...)
...
All available [field types (`type`)](https://github.com/webiny/webiny-js/tree/v5.25.0/packages/api-headless-cms/src/content/plugins/graphqlFields), [field renderers (`renderer.name`)](https://github.com/webiny/webiny-js/tree/v5.25.0/packages/app-headless-cms/src/admin/plugins/fieldRenderers), and [field validators (`validators.name`)](https://github.com/webiny/webiny-js/tree/v5.25.0/packages/api-headless-cms/src/content/plugins/validators) can be found in our GitHub repository.
...
Add the following code to the [`models.ts`](https://github.com/webiny/webiny-examples/blob/master/headless-cms/content-model-plugins/basic/api/code/headlessCMS/src/plugins/models.ts) file that we created earlier.
...
You can explore all the available [field validators](https://github.com/webiny/webiny-js/tree/v5.25.0/packages/api-headless-cms/src/content/plugins/validators) in our GitHub repository.
...
```diff-js api/code/headlessCMS/src/plugins/models.ts
export default [
  (...)
  fields: [
     (...)
...
With the [`webiny watch`](/docs/how-to-guides/use-watch-command/) command up and running,
