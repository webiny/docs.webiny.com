...
While executing deployment-related commands via the [Webiny CLI](../../core-development-concepts/basics/webiny-cli), for example [`deploy`](../../core-development-concepts/basics/project-deployment) or [`destroy`](../../infrastructure/basics/destroy-cloud-infrastructure), if not specified, Webiny will always use the `default` AWS profile.
