...
We will start with the [`PbEditorPageElementPlugin`](/docs/page-builder/references/plugins#pb-editor-page-element) plugin.  
...
The next plugin we'll need to define is the [`PbEditorPageElementAdvancedSettingsPlugin`](docs/page-builder/references/plugins#pb-editor-page-element-advanced-settings),
