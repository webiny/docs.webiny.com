...
To determine whether the React application has been deployed or not, we can run the following [`webiny output`](../../core-development-concepts/basics/webiny-cli#yarn-webiny-output---env-env) command:
