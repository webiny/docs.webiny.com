...
<_Heading level={3} id={"free"} nextElement={{
      "type": "paragraph"
    }}>Free</_Heading>
<p><strong parentName="p">{`For personal and hobby projects`}</strong></p>
...
<_Heading level={3} id={"business"} nextElement={{
      "type": "paragraph"
    }}>Business</_Heading>
<p><strong parentName="p">{`For small team projects`}</strong></p>
<Editor title="" lang="null" mdxType="Editor">
...
<_Heading level={3} id={"enterprise"} nextElement={{
      "type": "paragraph"
    }}>Enterprise</_Heading>
<p><strong parentName="p">{`For teams working on critical projects`}</strong></p>
<Editor title="" lang="null" mdxType="Editor">
{`- comes with SSO and team management and fine-grain security policies
