...
import staticToolbar from "/Users/svenalhamad/Dev/docs.webiny.com/docs/developer-docs/5.x/headless-cms/extending/assets/hcms-rte-static-toolbar.png";
import discoverToolbarActions from "/Users/svenalhamad/Dev/docs.webiny.com/docs/developer-docs/5.x/headless-cms/extending/assets/hcms-discover-toolbar-actions.png";
...
const tableOfContents = [{
  ...
  "children": [{
    ...
    "children": [{
      ...
      "slug": "remove-an-action"
    }, {
      "title": "Position an Action",
      "slug": "position-an-action"
    }]
  }, {
    "title": "Plugins",
    "slug": "plugins",
    "children": [{
      ...
      "slug": "replace-a-plugin"
    }, {
      "title": "Remove a Plugin",
      "slug": "remove-a-plugin"
    }, {
      "title": "Position a Plugin",
      "slug": "position-a-plugin"
    }, {
...
<WhatYouWillLearn mdxType="WhatYouWillLearn">- how to customize the Lexical editor in Headless CMS</WhatYouWillLearn>
...
<p>{`In this article, we’ll cover the Lexical Editor configuration for the Headless CMS Rich Text field. The configuration includes toolbar actions, plugins, and Lexical nodes.`}</p>
<_Heading level={3} id={"toolbar"} nextElement={{
      "type": "paragraph"
    }}>Toolbar</_Heading>
<p>{`Headless CMS uses a static toolbar, which is always visible. Webiny ships with a set of default actions, but you can add new actions, replace existing actions, or remove them completely.`}</p>
<Image src={staticToolbar} title="Static Rich Text Editor Toolbar" mdxType="Image" />
...
<_Heading level={4} id={"add-an-action"} nextElement={{
      "type": "paragraph"
    }}>Add an Action</_Heading>
<p>{`To add a new toolbar action, use the `}<inlineCode parentName="p">{`<ToolbarAction>`}</inlineCode>{` component and mount it within your Admin app.`}</p>
...
<_Heading level={4} id={"replace-an-action"} nextElement={{
      "type": "paragraph"
...
<_Heading level={4} id={"remove-an-action"} nextElement={{
      "type": "paragraph"
    }}>Remove an Action</_Heading>
<p>{`To remove an action, reference the existing action by name, and pass a `}<inlineCode parentName="p">{`remove`}</inlineCode>{` prop to the `}<inlineCode parentName="p">{`<ToolbarAction>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
...
<_Heading level={4} id={"position-an-action"} nextElement={{
      "type": "paragraph"
    }}>Position an Action</_Heading>
<p>{`To position an existing or a new custom action, use `}<inlineCode parentName="p">{`before`}</inlineCode>{` or `}<inlineCode parentName="p">{`after`}</inlineCode>{` props on the `}<inlineCode parentName="p">{`<ToolbarAction>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
...
<_Heading level={3} id={"plugins"} nextElement={{
      "type": "paragraph"
    }}>Plugins</_Heading>
...
<_Heading level={4} id={"add-a-plugin"} nextElement={{
      "type": "paragraph"
    }}>Add a Plugin</_Heading>
<p>{`To add a new Lexical plugin, you need to use the `}<inlineCode parentName="p">{`<Plugin>`}</inlineCode>{` component and mount it within your Admin app.`}</p>
...
<_Heading level={4} id={"replace-a-plugin"} nextElement={{
      "type": "paragraph"
...
<_Heading level={4} id={"remove-a-plugin"} nextElement={{
      "type": "paragraph"
    }}>Remove a Plugin</_Heading>
<p>{`To remove a plugin, reference the existing plugin by name, and pass a `}<inlineCode parentName="p">{`remove`}</inlineCode>{` prop to the `}<inlineCode parentName="p">{`<Plugin>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
...
<_Heading level={4} id={"position-a-plugin"} nextElement={{
      "type": "paragraph"
    }}>Position a Plugin</_Heading>
<p>{`To position an existing or a custom plugin, use `}<inlineCode parentName="p">{`before`}</inlineCode>{` or `}<inlineCode parentName="p">{`after`}</inlineCode>{` props on the `}<inlineCode parentName="p">{`<Plugin>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
...
<_Heading level={4} id={"built-in-plugins"} nextElement={{
      "type": "table",
...
<_Heading level={3} id={"nodes"} nextElement={{
      "type": "paragraph"
    }}>Nodes</_Heading>
...
<_Heading level={4} id={"add-a-node"} nextElement={{
      "type": "paragraph"
    }}>Add a Node</_Heading>
<p>{`To add a new Lexical node, use the `}<inlineCode parentName="p">{`<Node>`}</inlineCode>{` component and mount it within your Admin app.`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
...
<_Heading level={4} id={"replace-a-node"} nextElement={{
      "type": "paragraph"
...
<_Heading level={4} id={"remove-a-node"} nextElement={{
      "type": "paragraph"
    }}>Remove a Node</_Heading>
<p>{`To remove a node, reference the existing node by name, and pass a `}<inlineCode parentName="p">{`remove`}</inlineCode>{` prop to the `}<inlineCode parentName="p">{`<Node>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
...
<_Heading level={4} id={"position-a-node"} nextElement={{
      "type": "paragraph"
    }}>Position a Node</_Heading>
<p>{`To position your nodes, you can use `}<inlineCode parentName="p">{`before`}</inlineCode>{` and `}<inlineCode parentName="p">{`after`}</inlineCode>{` props on the `}<inlineCode parentName="p">{`<Node>`}</inlineCode>{` element:`}</p>
<Editor title="apps/admin/src/App.tsx" lang="jsx" mdxType="Editor">
{`import { LexicalEditorConfig } from "@webiny/app-headless-cms";
