...
import webinyOverview from "/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/assets/webiny-overview.mp4";
...
<p>{`1️⃣ `}<strong parentName="p">{`Page Builder`}</strong>{` - Build stunning landing pages with an easy to use Drag&drop editor.`}</p>
...
<p>{`4️⃣ `}<strong parentName="p">{`Form Builder`}</strong>{` - Build forms with a drag&drop editor. Insert forms through Page Builder into your pages. It has webhook support and ReCaptcha integration.`}</p>
{/* ================== AUTO-GENERATED ================== */}
