...
import _Image7 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/import-content-models-step-4.png'
import _Image6 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/import-content-models-step-3.png'
import _Image5 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/import-content-models-step-2.png'
import _Image4 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/import-content-models-step-1.png'
import _Image3 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/import-content-models.png'
import _Image2 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/export-content-models-step-2.png'
import _Image1 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/advanced/assets/import-export-content-models/export-content-models-step-1.png'
...
<ol>
<li parentName="ol">
<p parentName="li">{`From the `}<strong parentName="p">{`Side Menu`}</strong>{`, Click `}<strong parentName="p">{`Headless CMS`}</strong>{` > `}<strong parentName="p">{`Models`}</strong>{`.`}<br parentName="p"></br>{`
`}{`✔️ The Content Models screen opens.`}</p>
</li>
<li parentName="ol">
{`Click the `}
<strong parentName="li">{`kebab menu`}</strong>
{` icon ( ⁝ ) on the top right of the page.`}
<br parentName="li"></br>


{`✔️ Menu opens with the options `}
...
{`.
`}
<Image src={_Image3} alt={"Headless CMS - Export Content Models"} mdxType="Image" />
</li>
<li parentName="ol">
<p parentName="li">{`Click `}<strong parentName="p">{`Import models`}</strong>{`.`}<br parentName="p"></br>{`
`}{`✔️ The system will ask you to provide an export file.`}</p>
</li>
<li parentName="ol">
{`Select the file you want to import and click the `}
...
<li parentName="ol">
{`Choose the content model you want to import. From the list you can choose which content model you want to import and which ones you want to skip.
`}
...
<li parentName="ol">{`Finally, once you have selected which content models you want to import. Click the `}<strong parentName="li">{`Import`}</strong>{` button to start the import process.`}</li>
</ol>
<Image src={_Image7} alt={"Headless CMS - Import Content Models"} mdxType="Image" />
