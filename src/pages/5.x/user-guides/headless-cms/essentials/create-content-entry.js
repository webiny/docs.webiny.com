...
import _Image1 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/essentials/assets/create-content-entry/content-entry-revision.png'
import { Heading as _Heading } from '@/components/Heading'
import { Alert } from "@/components/Alert";
import createContentEntry from "/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/5.x/headless-cms/essentials/assets/create-content-entry/create-content-entry.mp4";
...
<p>{`In the previous tutorial, we learned how to create a `}<_Link href="/docs/5.x/user-guides/headless-cms/essentials/create-content-model">{`content model`}</_Link>{`, and
in this tutorial, we will explore how to create a `}<_Link href="/docs/5.x/user-guides/headless-cms/essentials/glossary#content-entry">{`content entry`}</_Link>{`.
...
If you don’t have any content model yet, please follow this `}<_Link href="/docs/5.x/user-guides/headless-cms/essentials/create-content-model">{`tutorial`}</_Link>{` to create a content model.`}</p>
...
<li parentName="ol">
<p parentName="li">{`Congratulations! You have created your first content entry.`}</p>
</li>
</ol>
