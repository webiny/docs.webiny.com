...
<ul>
<li parentName="ul">{`What is exported from `}<inlineCode parentName="li">{`webiny/admin/build-params`}</inlineCode>{`?`}</li>
...
<p>{`This page documents everything exported from `}<inlineCode parentName="p">{`webiny/admin/build-params`}</inlineCode>{`. Import any of the items below directly from this path in your Webiny extensions.`}</p>
<SymbolList symbols={[{
      name: "BuildParam",
      anchor: "build-param"
    }, {
...
<p><strong parentName="p">{`Abstraction`}</strong>{` — imported from `}<inlineCode parentName="p">{`webiny/admin/build-params`}</inlineCode></p>
