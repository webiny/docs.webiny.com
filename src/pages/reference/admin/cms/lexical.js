...
<ul>
<li parentName="ul">{`What is exported from `}<inlineCode parentName="li">{`webiny/admin/cms/lexical`}</inlineCode>{`?`}</li>
...
<p>{`This page documents everything exported from `}<inlineCode parentName="p">{`webiny/admin/cms/lexical`}</inlineCode>{`. Import any of the items below directly from this path in your Webiny extensions.`}</p>
<SymbolList symbols={[{
      name: "Divider",
      anchor: "divider"
    }, {
...
<p><strong parentName="p">{`Export`}</strong>{` — imported from `}<inlineCode parentName="p">{`webiny/admin/cms/lexical`}</inlineCode></p>
...
<p><strong parentName="p">{`Type`}</strong>{` — imported from `}<inlineCode parentName="p">{`webiny/admin/cms/lexical`}</inlineCode></p>
<Editor title="" lang="typescript" mdxType="Editor">
