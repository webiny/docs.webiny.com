...
import referenceField from "/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/6.0.x/headless-cms/essentials/assets/reference-field/reference-field.mp4";
...
As an example, we will use the `}<strong parentName="p">{`Product`}</strong>{` content model that we created in the `}<_Link href="/docs/user-guides/headless-cms/essentials/create-content-model">{`Create Content Model`}</_Link>{` tutorial.
...
<p>{`If you are not familiar with how to create a content model, please follow the `}<_Link href="/docs/user-guides/headless-cms/essentials/create-content-model">{`Create Content Model`}</_Link>{` tutorial.`}</p>
<ol>
<li parentName="ol">
...
<td parentName="tr" {...{
                "align": "left"
              }}>{`If you have created `}<strong parentName="td">{`E-commerce`}</strong>{` group, select it, else select `}<strong parentName="td">{`Ungrouped`}</strong></td>
</tr>
<tr parentName="tbody">
<td parentName="tr" {...{
                "align": "left"
...
<td parentName="tr" {...{
                "align": "left"
              }}><strong parentName="td">{`(boxes)`}</strong></td>
</tr>
<tr parentName="tbody">
<td parentName="tr" {...{
                "align": "left"
...
<ol parentName="li">
<li parentName="ol">{`Hover over the `}<strong parentName="li">{`Category`}</strong>{` content model.  `}</li>
...
<p parentName="li">{`✔️ The `}<strong parentName="p">{`New Category`}</strong>{` entry screen opens.`}</p>
</li>
<li parentName="ol">
...
<p parentName="li">{`✔️ The message “Clothes was published successfully!” displays.`}</p>
</li>
</ol>
...
<p parentName="li"><strong parentName="p">{`Note`}</strong>{`: Since a product can belong to multiple categories, enabling `}<strong parentName="p">{`Use as a list of references`}</strong>{` will allow you to associate multiple categories to a product.`}</p>
</li>
<li parentName="ol">
...
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Category`}</strong>{` field:`}</p>
<ol parentName="li">
<li parentName="ol">
<p parentName="li">{`Click `}<strong parentName="p">{`Select an existing record.`}</strong></p>
<p parentName="li">{`✔️ The `}<strong parentName="p">{`Select an existing record`}</strong>{` screen opens.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the search bar, type `}<strong parentName="p">{`Clothes`}</strong>{`.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`Click the `}<strong parentName="p">{`Clothes`}</strong>{` list item.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`Click `}<strong parentName="p">{`Save`}</strong>{`.`}</p>
</li>
...
<li parentName="ol">
<p parentName="li">{`Click `}<strong parentName="p">{`Yes, publish!`}</strong></p>
<p parentName="li">{`✔️ The message “Men’s Trio ‘21 Pants was published successfully!” displays.`}</p>
</li>
</ol>
{/* ================== AUTO-GENERATED ================== */}
