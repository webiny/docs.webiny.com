...
import _Image1 from '/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/6.0.x/headless-cms/essentials/assets/create-content-model/field-validators.png'
import { Heading as _Heading } from '@/components/Heading'
import { Alert } from "@/components/Alert";
import createContent from "/Users/svenalhamad/Dev/docs.webiny.com/docs/user-guides/6.0.x/headless-cms/essentials/assets/create-content-model/create-content-model.mp4";
...
<p>{`In this tutorial, we will learn how to create a `}<_Link href="/docs/user-guides/headless-cms/essentials/glossary#content-model">{`content model`}</_Link>{`.
...
we will define model `}<_Link href="/docs/user-guides/headless-cms/essentials/glossary#field-field-type">{`fields`}</_Link>{`.`}</p>
...
<p parentName="li">{`✔️ The `}<strong parentName="p">{`New Content Model`}</strong>{` screen opens.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Name`}</strong>{` textbox, type `}<strong parentName="p">{`Product`}</strong>{`.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Singular API Name`}</strong>{` textbox, type `}<strong parentName="p">{`Product`}</strong>{`.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Plural API Name`}</strong>{` textbox, type `}<strong parentName="p">{`Products`}</strong>{`.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Content model group`}</strong>{` drop-down, if you have already created a group, click that group, else click `}<strong parentName="p">{`Ungrouped`}</strong>{`.`}</p>
</li>
<li parentName="ol">
<p parentName="li">{`In the `}<strong parentName="p">{`Icon`}</strong>{` dropdown, click the `}<strong parentName="p">{`box`}</strong>{` icon (📦).`}</p>
</li>
<li parentName="ol">
...
<li parentName="ol">
<p parentName="li">{`Unselect the `}<strong parentName="p">{`Create model with default fields`}</strong>{` checkbox.`}</p>
</li>
<li parentName="ol">
