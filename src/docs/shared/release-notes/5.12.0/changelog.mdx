...
Make sure you didn't miss the **[5.11.1](/docs/{version}/release-notes/5.11.1/changelog)** release, which was an urgent security hotfix! You **must** apply that upgrade before moving on to **5.12.0**.

Please check the [Webiny 5.12.0 migration guide](/docs/{version}/release-notes/5.12.0/upgrade-guide) for the upgrade steps.
...
To learn more about the UI Composer, please visit the [official documentation](/docs/{version}/key-topics/ui-composer/introduction).
...
Be sure to check out the [Define Content Models via Plugins](../../headless-cms/extending/define-content-models-via-code) guide to learn more.
