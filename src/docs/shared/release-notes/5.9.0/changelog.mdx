...
To learn more about scaffolding and all of the available scaffolds, check out the [Scaffolding](../../core-development-concepts/scaffolding/introduction) how-to guides section.
