...
In addition to that, you can also use a fine-grained policy for the [CLI user](/docs/{version}/how-to-guides/deployment/aws/configure-aws-credentials/#attaching-a-fine-grained-policy), which is important for making secure deploys of your Webiny project.
...
From now on, all Webiny projects will use [Pulumi](../../infrastructure/pulumi-iac/iac-with-pulumi) v3.
...
Learn more about CI/CD and how to set it up for your Webiny project in our [CI/CD key topics](../../core-development-concepts/ci-cd/introduction).
