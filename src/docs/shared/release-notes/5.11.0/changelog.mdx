...
In addition to that, you can also use a fine-grained policy for the [CLI user](/docs/{version}/infrastructure/aws/configure-aws-credentials#attaching-a-fine-grained-policy), which is important for making secure deploys of your Webiny project.
