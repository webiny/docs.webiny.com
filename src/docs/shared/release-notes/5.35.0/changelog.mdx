...
Users can now choose an icon to represent their model in the UI.
...
To find out more about our benchmark tool and how to enable it in your project, please read this [article] TODO.
