...
### Error Logs ([#3122](https://github.com/webiny/webiny-js/pull/3122))

We now log errors via the `console.error` method, so they are properly marked in the Cloudwatch.
