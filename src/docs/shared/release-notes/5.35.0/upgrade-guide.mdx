...
### Theming-related Updates

The upgrade command will perform a couple of code level updates related to theming. The following sections will explain what changes are made, and how you can manually apply them if the upgrade command fails to do so.
