...
## Upgrade Command - Additional Notes
...
The following warning message will be displayed if the upgrade command fails to update the `styles.typography` object: **Custom key {KEY_NAME} could not be migrated.**
...
### Custom key webiny-pb-typography-body could not be migrated

TODO

### Could not migrate all typography-related code
