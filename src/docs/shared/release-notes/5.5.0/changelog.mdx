...
Let’s say you wanted to expand the default GraphQL API, that’s deployed as part of the [API](../../architecture/api/overview) project application. At the moment, in order to do that, you’d have to do the following:
