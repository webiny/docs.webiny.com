...
Now you're ready to redeploy your API and apps. By now, you're most likely familiar with the deployment process, but if you need a refresher, visit our [Deploy Your Project](../../core-development-concepts/basics/project-deployment) guide for everything related to deployments.
