...
#### ✍️ Ability to Provide a LinkedIn Profile URL ([#3362](https://github.com/webiny/webiny-js/pull/3362))
...
#### ✍️ Block Editor - Addressed Back Button's Navigation Issue ([#3361](https://github.com/webiny/webiny-js/pull/3361))

#### ✍️ Fixed Icon In the Revisions Dropdown Menu ([#3361](https://github.com/webiny/webiny-js/pull/3361))
...
#### ✍️ List of Revisions - Revisions Now Shown From Latest to Oldest ([#3379](https://github.com/webiny/webiny-js/pull/3379))

#### ✍️ Fixed Setting Background Image on a Page Elements ([#3378](https://github.com/webiny/webiny-js/pull/3378))
