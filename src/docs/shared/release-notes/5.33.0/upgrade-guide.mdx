...
Make sure to check out the [5.33.0 changelog](./changelog) to get familiar with the changes introduced in this release.
...
Please follow [this](/docs/headless-cms/extending/content-models-via-code-storage-id) article.
