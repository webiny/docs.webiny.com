...
### Fixed Deletion Page Revisions  ([#3468](https://github.com/webiny/webiny-js/pull/3468))
...
We've received a couple of reports of the Admin application becoming slow or even unresponsive when rendering large data sets, for example lists of pages or list of Headless CMS content entries.

With this release, we've optimized the rendering of large data sets, which should now be more performant and should not cause the Admin application to become unresponsive.
