...
We believe that this feature will be especially useful for larger organizations that have a lot of content and a lot of users, and that need to have an even more granular control over who can access what content.
