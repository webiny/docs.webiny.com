...
### Content Inconsistency Issues In Template Editor ([#3286](https://github.com/webiny/webiny-js/pull/3286))

Because of an issue in the related backend GraphQL API mutation, after doing a full page refresh, Page Builder's template layout editor would intermittently fail to show the latest template content.
