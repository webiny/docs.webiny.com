...
<Alert type="info" title="Project Applications">
  ...
  Learn more about project applications and project organization in general, in the [Project Applications and Packages](/docs/5.34.x/core-development-concepts/project-organization/project-applications) key topic.

</Alert>

For more information about this new feature, please visit the [Application Aliases](#) section of the existing [Webiny CLI](/docs/5.34.x/core-development-concepts/basics/webiny-cli) article.
...
For more information about this new feature, please visit the updated [Environment Variables](/docs/5.34.x/core-development-concepts/basics/environment-variables) article.
