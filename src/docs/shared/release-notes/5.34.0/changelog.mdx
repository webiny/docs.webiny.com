...
Until now, when some code error happened (for example: reading property of null value), users got the `500` error code with the `Internal Server Error` message.
