...
Please check the [Webiny 5.6.0 migration guide](/docs/{version}/release-notes/5.6.0/upgrade-guide) for the upgrade steps.
...
In our [previous release](/docs/{version}/release-notes/5.5.0/changelog), we released the brand new [`webiny watch`](/docs/{version}/release-notes/5.5.0/changelog#brand-new-webiny-watch-command-1540) command. But, we didn't stop there, so today, we're happy to introduce its first improvement.
