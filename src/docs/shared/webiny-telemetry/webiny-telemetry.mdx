...
| [Admin Dashboard](https://www.npmjs.com/package/webiny-admin)|<ul><li>Drive product improvements</li><li>Product usage insights</li></ul> |<ul><li>Admin App launched</li><li>Custom website domain updated (with domain name provided)</li></ul> |<ul><li>Event name</li><li>Timestamp</li><li>Product version</li><li>Unique project ID (UUID)</li><li>Admin App URL</li><li>End-user IP Address</li><li><strong>Custom website domain event</strong></li><li>Website URL</li></ul>|Optional via opt-out|
