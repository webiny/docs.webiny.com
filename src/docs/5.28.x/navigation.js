...
import { Collapsable, Section, Page, Separator, NavGroup } from "@/docs/utils/navigation";
        ...
        <>
            ...
            <Collapsable title={"Core Development Concepts"}>
                ...
                <Section title={"Project Organization"}>
                    <Page
                        link={"core-development-concepts/project-organization/project-applications"}
                    />
                    <Page
                        link={
                ...
                <Section title={"CI/CD"}>
                    ...
                    <Page
                        link={"core-development-concepts/ci-cd/cloud-infrastructure-state-files"}
                    />
