...
This article covers the general idea of environments and how they are embedded into a Webiny project. To learn how to deploy your project using [Webiny CLI](../../core-development-concepts/basics/webiny-cli), please visit the [Deploy your project](../../core-development-concepts/basics/project-deployment) guide.
...
For best practices on how to organize your environments and other workflows, check out the [Workflows](../../core-development-concepts/ci-cd/workflows) section.
...
Fortunately, Webiny makes it easy to work with different environments, using the [Webiny CLI](../../core-development-concepts/basics/webiny-cli) and [Pulumi](../../infrastructure/pulumi-iac/iac-with-pulumi). Be sure to check out the [Deploy your project](../../core-development-concepts/basics/project-deployment) guide to learn how to deploy a Webiny project.

<Alert type="danger" title="Watch out for extra costs">

Deploying multiple project environments into the same AWS account may incur additional cost. Check out the [Cloud Infrastructure](../../architecture/introduction) section for more information.
...
Depending on the environment, the **API** project application is deployed as two different sets of cloud infrastructure resources - development and production. Visit the [API Introduction](../../architecture/api/introduction#different-cloud-infrastructure-setups) key topic to learn more.
