...
Out of the box, [Webiny CLI](../../core-development-concepts/basics/webiny-cli) provides all of the essential commands that you might need in order to [preview](../../infrastructure/basics/preview-deployments), [deploy](../../core-development-concepts/basics/project-deployment), and [destroy](../../infrastructure/basics/destroy-cloud-infrastructure) your project applications' cloud infrastructure resources.
