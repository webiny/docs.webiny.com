...
<Alert type={"info"}>
  Before deploying the AWS CloudFormation template, you might want to inspect it. You can do that by visiting our <a target="_blank1" href={"https://github.com/webiny/webiny-js/blob/stable/docs/DEPLOY_WEBINY_PROJECT_CF_TEMPLATE.yaml"}>GitHub repository</a>.
</Alert>
