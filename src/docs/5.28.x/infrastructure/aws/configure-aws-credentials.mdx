...
<Alert type="warning" title="Want fine-grained permissions?">
...
please see the [attaching fine-grained policy](../../infrastructure/aws/configure-aws-credentials#attaching-a-fine-grained-policy) section.
...
If you don't have one please refer to the [previous step](../../infrastructure/aws/configure-aws-credentials#step-2-create-a-user-for-programmatic-access).

</Alert>

Alternatively, you can also define a fine-grained policy using our [CloudFormation template](https://webiny-public.s3.us-east-2.amazonaws.com/cloudformation/iam-group-webiny-project-full.json)
...
You can do this by clicking [create stack](https://console.aws.amazon.com/cloudformation/home?#/stacks/create/review?templateURL=https://webiny-public.s3.us-east-2.amazonaws.com/cloudformation/iam-group-webiny-project-full.json&stackName=DeployWebinyProject):
...
If you would like to use a different name for your AWS profile, you can do that too. Check out the [Use AWS Profiles](../../infrastructure/aws/use-aws-profiles) how-to guide for more information.
