...
1. [Set up your AWS credentials locally](/docs/infrastructure/aws/configure-aws-credentials)
2. [Deployed a Webiny instance to a dev environment](/docs/core-development-concepts/basics/project-deployment)
...
There's [more information about using GraphQL here](/docs/headless-cms/basics/using-graphql-api).
