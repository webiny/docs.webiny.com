...
Learn more about differences between the development and production cloud infrastructure differences in the [Cloud Infrastructure](/docs/5.28.x/architecture/api/overview) key topic.
