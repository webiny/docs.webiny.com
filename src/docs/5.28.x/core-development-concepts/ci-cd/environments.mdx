...
Learn more about differences between the development and production cloud infrastructure differences in the [Cloud Infrastructure](../../architecture/api/introduction#different-cloud-infrastructure-setups) key topic.
