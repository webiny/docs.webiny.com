...
With the all of the GraphQL API changes in place, let's wrap up the [Security](../../custom-app-tutorial/security-overview/introduction) section of the tutorial by returning back to our React application and making one small addition to the **Pin Details** page, which currently looks like this:
...
By performing these last couple of changes outlined in the section above, we've completed the [Security](../../custom-app-tutorial/security-overview/introduction) section of this tutorial!
