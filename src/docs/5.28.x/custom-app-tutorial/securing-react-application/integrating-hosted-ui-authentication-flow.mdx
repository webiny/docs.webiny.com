...
On the other hand, if the user is already signed in, then we'll show the existing **&#10753;** icon, which, as [previously seen](../../custom-app-tutorial/react-application/new-pin-modal-dialog), is used to open the **New Pin** modal dialog.
