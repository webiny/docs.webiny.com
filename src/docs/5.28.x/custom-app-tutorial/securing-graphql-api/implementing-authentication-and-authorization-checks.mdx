...
At the moment, all pins-related queries and mutations that were created during the [Extend GraphQL API](../../core-development-concepts/scaffolding/extend-graphql-api) scaffolding process are publicly accessible.
