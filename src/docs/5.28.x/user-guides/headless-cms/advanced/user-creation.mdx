...
Webiny allows you to add multiple users with different access permissions to your instance. You can define a custom user role with custom access by creating a user group. 
In this tutorial, we will learn how to create a user group with custom access to the CMS. Then we will create a user within that user group.
