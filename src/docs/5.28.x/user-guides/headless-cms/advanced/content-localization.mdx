...
It provides you the flexibility to define different content schemas for different locales. That means for each locale, you can create separate content model groups, content models, content entries, etc.

When you create a new locale, you get a clean slate in which you can create new content models and content entries. This gives you the flexibility to define variations of content models depending on your locales.
...
1. Add a content entry in the **Prodotto** content model with the following attributes:
    ...
    **Note**: If you are not familiar with how to create a content entry, please follow the [Create Content Entry](../essentials/create-content-entry) tutorial.