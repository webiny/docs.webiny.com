...
In the previous tutorial, we learned how to create a [content model](../essentials/create-content-model), and
in this tutorial, we will explore how to create a [content entry](../essentials/glossary#content-entry). 
...
If you don't have any content model yet, please follow this [tutorial](../essentials/create-content-model) to create a content model.
