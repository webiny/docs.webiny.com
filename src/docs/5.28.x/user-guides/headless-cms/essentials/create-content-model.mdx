...
In this tutorial, we will learn how to create a [content model](../essentials/glossary#content-model). 
...
we will define model [fields](../essentials/glossary#field-field-type).
