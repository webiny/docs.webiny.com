...
Checkout this tutorial on how to create [custom Page Builder elements](../../page-builder/extending/create-a-custom-page-element).
...
Checkout the Page Builder page delivery performance in the [benchmark section](../../performance-and-load-benchmark/introduction).
