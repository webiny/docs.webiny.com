...
To connect your project with Webiny Control Panel, run the following command:
...
a custom domain is not required. If so, you can skip to [project
deployment](#5-deploy-your-project). However, if you want to build websites for each tenant, you will have
