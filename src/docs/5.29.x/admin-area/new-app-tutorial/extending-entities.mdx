...
```ts api/graphql/src/plugins/scaffolds/carManufacturers/entities/CarManufacturer.ts
(...)
...
```ts api/graphql/src/plugins/scaffolds/carManufacturers/types.ts
...
```ts api/graphql/src/plugins/scaffolds/carManufacturers/typeDefs.ts
