...
To learn more about configuring your AWS credentials, please check out the [Configure AWS Credentials](../../infrastructure/aws/configure-aws-credentials) guide. If you're looking for information on how to use different AWS profiles, feel free to skip to the [Use AWS Profiles](../../infrastructure/aws/use-aws-profiles) guide.
...
As explained in the [introduction to deployment](../../infrastructure/basics/introduction) key topic, doing a complete project deployment entails deploying all of its [project applications](../../core-development-concepts/project-organization/project-applications-and-packages).
...
```bash
yarn webiny pulumi apps/api --env dev -- stack --show-ids
```
...
For more information on the `webiny pulumi` command, please visit the [Execute Pulumi Commands](../../infrastructure/pulumi-iac/execute-pulumi-commands) guide.

</Alert>

<Alert type="success">

By default, every Webiny project consists of three project applications: **API** (`apps/api`), **Admin Area** (`apps/admin`), and **Website** (`apps/website`).
Read more about project organization in the [Project Organization](../../core-development-concepts/project-organization/project-applications-and-packages) key topics section.
...
To learn more, please check out the [Modify Cloud Infrastructure](/docs/5.29.x/infrastructure/basics/modify-cloud-infrastructure) article.
...
```bash
yarn webiny deploy apps/api --env dev --debug
```
...
This error can occur if one of the previous deployments of your [project application](../../core-development-concepts/project-organization/project-applications-and-packages) has been [interrupted](../../core-development-concepts/basics/project-deployment#one-of-the-previous-deployments-has-been-interrupted), or another deployment is [currently in progress](../../core-development-concepts/basics/project-deployment#another-deployment-currently-in-progress).
...
If you didn't install the Pulumi CLI manually by yourself, which is usually the case for most Webiny users, you can execute the above commands via the [`pulumi`](../../infrastructure/pulumi-iac/execute-pulumi-commands) command, for example:
...
yarn webiny pulumi apps/api --env prod -- stack export
```

<Alert type="info">

Learn more about cloud infrastructure state files in the [Cloud Infrastructure State Files](../../core-development-concepts/ci-cd/cloud-infrastructure-state-files) development workflows guide.
