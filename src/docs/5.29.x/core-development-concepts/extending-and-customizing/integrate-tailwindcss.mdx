...
```js apps/website/applyTailwindToWebpack.js
...
```js apps/website/tailwind.config.js
...
```tsx apps/website/src/ExampleMadeWithTailwindCSS.tsx
...
you can directly add the directives to `(apps/website/src/App.scss)` file for the **Website** application.
