...
To learn more about the necessary cloud infrastructure resources Webiny is relying on, check out the [Cloud Infrastructure](../../architecture/introduction) section.
