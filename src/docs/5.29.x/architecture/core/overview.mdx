...
The service is utilized from the **Default GraphQL API** and **Headless CMS GraphQL API** AWS Lambda functions, both part of the [API project application](/docs/{version}/architecture/api/introduction).
