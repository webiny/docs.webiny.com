...
If we wanted to compare these applications by the complexity of the cloud infrastructure they deploy, we could say that **Core** and **API** are the more complex ones. This is simply because these deploy more different cloud infrastructure resources than the remaining **Admin** and **Website** project applications.
...
At the moment, Webiny can be exclusively deployed into [Amazon Web Services (AWS)](https://aws.amazon.com/), where users can choose between two different setups:
