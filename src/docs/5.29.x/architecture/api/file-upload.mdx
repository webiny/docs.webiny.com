...
3. Finally, another GraphQL request is issued, which instructs the GraphQL Handler <diagram-letter>C</diagram-letter> to store the file meta data. The data is stored both in Amazon DynamoDB <diagram-letter>E</diagram-letter> and Amazon ElasticSearch Service <diagram-letter>F</diagram-letter>.
