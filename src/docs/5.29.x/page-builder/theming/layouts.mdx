...
The options available inside the layout dropdown are registered by the [`pb-page-layout`](../references/plugins#pb-page-layout) plugin.
...
Now we register this layout as the [`pb-page-layout`](../references/plugins#pb-page-layout) plugin.
