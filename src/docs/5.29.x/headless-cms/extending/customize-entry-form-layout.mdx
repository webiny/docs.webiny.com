...
There's only one plugin you need to implement to create a custom form layout: [CmsContentFormRendererPlugin](../references/plugins#cms-content-form-renderer).
