...
Internally, the [`webiny deploy`](/docs/{version}/how-to-guides/deployment/deploy-your-project/) command consists of two steps:
...
This is why the [`webiny deploy`](/docs/{version}/how-to-guides/deployment/deploy-your-project/) command enables hooking onto a couple of its key lifecycle events:
...
Except for the [`webiny deploy`](/docs/{version}/how-to-guides/deployment/deploy-your-project/) command, hooking onto key lifecycle events is also supported by the [`webiny watch`](/docs/{version}/core-development-concepts/basics/watch-command) command.
