...
In order to create a new full stack application, behind the scenes, the scaffold is relying on the existing [GraphQL API](../../core-development-concepts/scaffolding/graphql-api) and [React Application](../../core-development-concepts/scaffolding/react-application) scaffolds.
...
The Full Stack Application scaffold creates everything that you might need in order to start creating a new full stack application. It creates two [project applications](../../core-development-concepts/project-organization/project-applications), one that holds your frontend, and the other one that holds your backend application.

The frontend application is powered by React and is created with the [React Application](../../core-development-concepts/scaffolding/react-application) scaffold. On the other hand, the backend application is powered by a GraphQL API and is created with the [GraphQL API](../../core-development-concepts/scaffolding/graphql-api) scaffold.

<Alert type="info">

For more information on specific features that these two scaffolds include, we recommend you check out the dedicated [React Application](../../core-development-concepts/scaffolding/react-application) and [GraphQL API](../../core-development-concepts/scaffolding/graphql-api) guides.
...
During the scaffold's setup wizard, users get to choose whether they want to also include a simple GraphQL API interaction example code. In other words, the scaffold will create an additional page in your React application and extend the GraphQL API with a basic set of CRUD queries and mutations (using the [Extend GraphQL API](../../core-development-concepts/scaffolding/extend-graphql-api) scaffold).
...
Check out the React Application scaffold's [Development](../../core-development-concepts/scaffolding/react-application#development-using-the-watch-command) section to learn how to start the React application locally.
...
The following is brief overview of the essential files and folders that are created during the scaffolding process. For more information, we encourage you to check out the dedicated [React Application](../../core-development-concepts/scaffolding/react-application#essential-files-and-folders) and [GraphQL API](../../core-development-concepts/scaffolding/graphql-api#essential-files-and-folders) guides.
...
During the scaffold's setup wizard, you will be asked if you want to immediately deploy the created GraphQL API. If you decide not to do it, you can deploy it later, as usual, with the [`webiny deploy`](../../core-development-concepts/basics/project-deployment) command.
...
If you're just working on one side of your application, for example on your GraphQL API, you don't necessarily need to run both [`webiny watch`](../../core-development-concepts/basics/watch-command) commands.

</Alert>

### Extending the GraphQL API

The new GraphQL API can be extended in two ways. Be sure to check the [Extending GraphQL API](../../core-development-concepts/scaffolding/graphql-api#extending-the-graphql-api) section in the [GraphQL API](../../core-development-concepts/scaffolding/graphql-api) scaffold's guide.

### Extending the React application

On the React application side, you can start by creating new pages, in the similar fashion it's already done with the existing example pages. Be sure to check the [Creating First Pages](../../core-development-concepts/scaffolding/react-application#creating-first-pages) section in the [GraphQL API](../../core-development-concepts/scaffolding/react-application) scaffold's guide.
