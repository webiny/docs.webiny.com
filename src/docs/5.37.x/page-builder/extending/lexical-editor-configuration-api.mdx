...
|----------------------|----------------------------------------------------------------------------------------|-----------------------------------------|
| Header.ToolbarAction | name: string  element: React.Element  after: string  before: string  remove: boolean   | Add/remove/update Lexical actions.      |
| Header.Plugin        | name: string  element: React.Element  after: string  before: string  remove: boolean   | Add/remove/update Lexical plugins.      |
| Header.Node          | name: string  node: `Klass<LexicalNode>`  after: string  before: string  remove: boolean | Add/remove/update Lexical custom nodes. |                  |                                                                                      |                                    |

## Paragraph configuration options

| Component            | Props                                                                                  | Description                             |
|----------------------|----------------------------------------------------------------------------------------|-----------------------------------------|
| Paragraph.ToolbarAction | name: string  element: React.Element  after: string  before: string  remove: boolean   | Add/remove/update Lexical actions.      |
| Paragraph.Plugin        | name: string  element: React.Element  after: string  before: string  remove: boolean   | Add/remove/update Lexical plugins.      |
| Paragraph.Node          | name: string  node: `Klass<LexicalNode>`  after: string  before: string  remove: boolean | Add/remove/update Lexical custom nodes. |                  |                                                                                      |                                    |

<Alert type={"info"}>
  When you update or add a new action, plugin, or node you must `name` it as a required prop. By this name, we track and manage configurations.
  Webiny has names for all configuration options. Please check the **Lexical Components Catalog** topic.
</Alert>
...
<Alert type={"warning"}>
  Be aware that plugins and nodes related to this particular action are still mounted.
</Alert>
