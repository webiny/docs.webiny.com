...
The easiest way to discover existing actions is to use the React Dev Tools plugins for your browser, and look for the name of action element. From there, you can look at Fragment key value.
<Image
...
#### Remove Action
Sometimes you might want to remove an action. All you need to do is reference the action by name, and pass a `remove` prop to the `<Heading.ToolbarAction>` element:
```jsx apps/admin/src/App.tsx
<LexicalEditorConfig>
{/* Custom action */}
...
#### Remove Plugin
Sometimes you might want to remove a plugin. All you need to do is reference the plugin by name, and pass a `remove` prop to the `<Heading.Plugin>` element:
```jsx apps/admin/src/App.tsx
  {/* Add a new plugin */}
  <Heading.Plugin name={"newPlugin"} element={<NewPlugin/>} />
```
#### Position Plugin
...
#### Position Node
To position your nodes, you can use `before` or `after` props on the `<Heading.Plugin>` element:
```jsx apps/admin/src/App.tsx
...
#### Remove Action
Sometimes you might want to remove an action. All you need to do is reference the action by name, and pass a remove prop to the `<Paragraph.ToolbarAction>` element:
```jsx apps/admin/src/App.tsx
<LexicalEditorConfig>
