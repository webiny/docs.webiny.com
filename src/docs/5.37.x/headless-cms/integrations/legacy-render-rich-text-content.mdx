...
<Alert type="warning">
  This article is moved from version 5.37.0 to new page. Clink on this <Link href={"https://www.webiny.com/docs/headless-cms/integrations/render-lexical-rich-text-content"}>link</Link> to learn more.
</Alert>
