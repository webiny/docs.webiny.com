...
<Alert title="LEXICAL CMS CONFIGURATION API" type={"info"}>
 Webiny leverages on the Lexical editor for content creation, please check the Lexical editor page to [learn more](https://lexical.dev/).
</Alert>
...
is copy your custom Lexical node from the webiny project, add to your custom project, and provide the Lexical node in array 
