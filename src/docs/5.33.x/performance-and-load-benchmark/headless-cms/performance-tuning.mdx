...
Existing indexes can be updated by issuing a remote REST API call to your Elasticsearch cluster:
...
Note that in almost all cases executing the above will result in authentication error.
