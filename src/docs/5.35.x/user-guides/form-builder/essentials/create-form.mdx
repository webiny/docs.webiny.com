...
To use a form, you need to embed it into a page. In this step, we we will embed the form into a page using the Page Builder. If you are not familiar with how to create a page, please follow the [Create Page](../../page-builder/essentials/create-page) tutorial.
