            ...
            <NavGroup type={"user-guides"}>
                ...
                <Collapsable title={"Headless CMS"}>
                    <Section title={"Essentials"}>
                        ...
                        />
                        <Page
                            link={"user-guides/headless-cms/essentials/content-entry-revisions"}
                        />
                        <Page link={"user-guides/headless-cms/essentials/clone-content-model"} />
                        <Page
                            link={
                                "user-guides/headless-cms/essentials/manage-content-model-settings"
                            }
                        />
                        <Page
                ...
                <Collapsable title={"Form Builder"}>
                    <Section title={"Essentials"}>
                        ...
                        <Page
                            link={"user-guides/form-builder/essentials/using-reCAPTCHA-in-form"}
                        />
                    </Section>
                </Collapsable>
            </NavGroup>
