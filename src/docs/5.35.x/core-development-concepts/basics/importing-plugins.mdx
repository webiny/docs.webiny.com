...
If you're not yet familiar with the concept of plugins in Webiny, please refer to the [Plugins](../../core-development-concepts/basics/plugins) key topic article.
...
- [React applications (Admin Area and Website)](../../core-development-concepts/basics/importing-plugins#react-applications)
- [GraphQL APIs (Main GraphQL API and Headless CMS API)](../../core-development-concepts/basics/importing-plugins#graphql-apis)
- [Webiny CLI](../../core-development-concepts/basics/importing-plugins#webiny-cli)
...
To register a new plugin, you need to navigate to the appropriate plugins entry file, and add your plugin to the end of the array that is being registered into the [PluginsContainer](../../core-development-concepts/basics/plugins#plugins-container).
...
```ts apps/{admin|website}/code/src/plugins/myPlugins.ts
...
```ts apps/{admin|website}/code/src/plugins/index.ts
...
```ts api/code/{graphql|headlessCMS}/src/plugins/myPlugins.ts
// A dedicated file for your custom plugin(s)
export default [
  {
    type: "my-plugin-type",
...
```ts api/code/{graphql|headlessCMS}/src/index.ts
// ...other imports...
...
If you already have the [watch](../../core-development-concepts/basics/watch-command#webiny-watch-command) running, the new import will be picked up, built, and deployed to the cloud automatically.

If not, you'll need to [deploy](../../core-development-concepts/basics/project-deployment#the-deploy-command) your API manually, to apply the new plugin(s).
...
To learn more, please read the [Plugins](../../core-development-concepts/basics/plugins) key topic article.
