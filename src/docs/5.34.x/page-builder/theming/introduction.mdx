...
This file exports a list of Page Builder theme plugins, and that's what you later import in your [**website**](https://github.com/webiny/webiny-js/blob/next/apps/website/src/plugins/index.ts#L7) app and then register as a plugin.
...
### [`pb-theme`](../references/plugins#pb-theme) Plugin
...
### [`pb-page-layout`](../references/plugins#pb-page-layout) Plugin
