...
import elementInSidebar from "./assets/create-a-custom-page-element/element-in-sidebar.png";
import elementSettings from "./assets/create-a-custom-page-element/page-element-settings.png";
import elementInEditor from "./assets/create-a-custom-page-element/element-in-editor.mp4";
...
![SpaceX Page Element](./assets/create-a-custom-page-element/preview.png)
...
![Page Preview In the Admin App](./assets/create-a-custom-page-element/admin-page-preview.png)
