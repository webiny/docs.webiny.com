...
Building this sort of security integration requires an in-depth understanding of Webiny's security model and posture as well as technical support from Webiny's engineering team.  We would highly discourage anyone from building these integrations on their own as we are only able to support integrations built by our team and cannot guarantee that 3rd party unmaintained integrations will work correctly, now or after future updates. 

**Why did you lock this feature under an enterprise offering?**

As with many other businesses we too need to have a sustainable revenue model. Webiny in the open-source version is giving away over 90% of its capabilities and features completely for free. But to fund the future development of Webiny certain features are only available under the Enterprise of Business paid tiers. By purchasing the paid features you are supporting us as a business and as product for many years to come. 