...
We highly recommend that you use the `production` stack for all your projects running production traffic. [Learn more about the stacks.](../../architecture/deployment-modes/introduction)
