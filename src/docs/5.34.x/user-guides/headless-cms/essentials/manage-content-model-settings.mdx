...
As an example, we will update the description of **Product** content model that we created in the [Create Content Model](../essentials/create-content-model) tutorial.
