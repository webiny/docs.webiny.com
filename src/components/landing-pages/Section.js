...
export const SectionTitle = ({ title, subText, categoryTitle }) => {
    return (
        <div className="px-0 mt-8 mx-auto lg:py-2">
            <div className="mr-auto">
                <span className="rounded-md text-[10px] text-orange font-bold bg-light-orange px-4 py-2 dark:bg-dark-orange uppercase">
                    {categoryTitle}
                </span>
...
export const SectionRow = ({ children }) => {
    return <div className="flex flex-col sm:flex-row gap-x-6 m-0">{children}</div>;
};
...
export const SectionBox = ({ Icon = null, title, children, learnMoreLink }) => {
    ...
    return (
        <div
            ...
            onClick={() => {
                linkClick(router, learnMoreLink);
            }}
        >
            <div className="p-2 mx-auto lg:py-2 items-center border-light-grey rounded-xl bg-gradient-to-b from-light-grey-6 to-white dark:from-dark-grey-5 to-black">
                <div className="mr-auto md:m-2 cursor-pointer">
                    {Icon && (
                        <div className="flex duration-200 mb-2 w-[48px] h-[48px] rounded bg-light-grey-7 justify-center items-center grayscale group-hover:grayscale-0 group-hover:bg-light-orange dark:bg-dark-grey-2 dark:group-hover:bg-dark-orange">
                            <Icon />
                        </div>
                    )}
                    ...
                    {learnMoreLink && (
                        <div className="md:mt-4 not-prose text-orange dark:text-orange group-hover:underline font-semibold md:text-xs dark:text-light-grey-6">
                            <a href={learnMoreLink} className="pointer-events-none">
                                Learn more →
                            </a>
                        </div>
                    )}
