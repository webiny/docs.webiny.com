...
const ListItem = ({label, Icon, link}) => {
    return (<li className="mb-4 last:mb-0" >
        <a className="flex justify-items-start text-dark-grey dark:text-light-grey dark:hover:text-orange hover:text-orange no-underline items-center group" href={link}>
...
export const FeatureList = ({items}) => {
    ...
    return <section className="bg-white dark:bg-dark-theme border-solid mb-10">
        <div className="grid max-w-screen-xl p-0 mx-auto lg:gap-8 xl:gap-0 lg:py-2 lg:grid-cols-12 items-center">
            <div className="mr-auto place-self-center lg:col-span-4 py-2 md:py-10 md:pr-5">
                <span className="rounded-md text-[10px] text-orange font-bold bg-light-orange px-4 py-2 dark:bg-dark-orange">FEATURES</span>
