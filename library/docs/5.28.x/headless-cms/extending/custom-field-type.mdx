...
```ts apps/admin/code/src/plugins/headlessCMS/fields/secretText/secretTextFieldPlugin.tsx
...
```diff-js apps/admin/code/src/plugins/headlessCms.ts
  (...)
...
2. Import this new plugin in `apps/admin/code/src/plugins/headlessCms.ts`.
...
```ts api/code/headlessCMS/src/fields/secretText/secretTextFieldPlugin.ts
...
4. Deploy the API changes, run the [`webiny watch`](../../core-development-concepts/basics/watch-command) command to start a new watch session on `api/code/headlessCMS` application code.
...
```ts api/code/headlessCMS/src/fields/secretText/secretTextFieldStoragePlugin.ts
...
```ts api/code/headlessCMS/src/fields/secretText/secretTextFieldStoragePlugin.ts {5}
const plugin = new StorageTransformPlugin({
  (...)
