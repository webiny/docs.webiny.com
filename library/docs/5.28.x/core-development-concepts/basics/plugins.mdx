...
This article gives a theoretical explanation of the concept. If you're looking for instructions on practical usage, please refer to the [Importing Plugins](../../core-development-concepts/basics/importing-plugins) article.
