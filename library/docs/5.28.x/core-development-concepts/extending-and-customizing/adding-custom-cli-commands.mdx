...
[Webiny CLI](../../core-development-concepts/basics/webiny-cli) is pluggable by default, which means you can create new commands, or even override existing ones, simply by adding a new plugin, with its type property set to `cli-command`.
