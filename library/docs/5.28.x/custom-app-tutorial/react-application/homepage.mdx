...
We already had a quick mention of the [`Home`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/02-layout/pinterest-clone/app/code/src/plugins/routes/home.tsx#L7) React component in the [Optional Steps](../../custom-app-tutorial/react-application/layout#optional-steps) section, in the [Layout](../../custom-app-tutorial/react-application/layout) section of this tutorial.
