...
Notice how we had to run the [`yarn workspace`](https://classic.yarnpkg.com/en/docs/cli/workspace/) command and specify the workspace name (`pinterest-clone-app`) in order to add the [`antd`](https://www.npmjs.com/package/antd) NPM package. This is because every Webiny project is organized as a monorepo and can consist of multiple workspaces. To learn more, check out the [Monorepo Organization](../../core-development-concepts/project-organization/monorepo-organization) key topic.
...
For more information, check out the [Essential Files and Folders](../../core-development-concepts/scaffolding/full-stack-application#essential-files-and-folders) section of the [React Application](../../core-development-concepts/scaffolding/full-stack-application#essential-files-and-folders) how-to guide.
