...
If you want to learn more about the main GraphQL API and how it works on the cloud infrastructure level, check out the [GraphQL Requests](../../architecture/api/graphql-requests) page of the [Cloud Infrastructure - API](../../architecture/api/introduction) key topics section.
