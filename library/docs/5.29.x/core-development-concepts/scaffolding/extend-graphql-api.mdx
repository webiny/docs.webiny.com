...
Learn more about the **API** project application on the cloud infrastructure level in the [Cloud Infrastructure](../../architecture/api/overview) key topics section.
