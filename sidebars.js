        ...
        },
        {
            "Release Notes": [
                "how-to-guides/upgrade-webiny",
                {
                    type: "category",
                    label: "5.24.0",
                    items: ["release-notes/5.24.0/changelog", "release-notes/5.24.0/upgrade-guide"]
                },
                {
                    type: "category",
                    label: "5.23.1",
                    ...
                    items: [
                        {
                            ...
                            label: "5.21.0",
                            items: [
                                "release-notes/5.21.0/changelog",
                                "release-notes/5.21.0/upgrade-guide"
                            ]
                        },
                        {
                            type: "category",
                            label: "5.20.0",
                            items: [
                                "release-notes/5.20.0/changelog",
                                "release-notes/5.20.0/upgrade-guide"
                            ]
                        },
                        {
                            type: "category",
