...
Although Webiny is mainly using serverless resources, it relies on **AWS ElasticsearchService**.
It is the only non-serverless component of our infrastructure and is charged per hour. It amounts to roughly $25/month.

Please keep this in mind, and if you just want to try Webiny, don't forget to destroy the infrastructure when you're done, to avoid the unnecessary expenses.
:::
