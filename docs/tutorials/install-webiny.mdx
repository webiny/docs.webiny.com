...
This tutorial covers how to create a brand new Webiny project, and how to deploy it to your [AWS](https://aws.amazon.com/) account. At the end of the tutorial, you end up with a deployed Webiny project, fully accessible over a couple of public URLs.
...
Please try executing the command in your terminal, and run the deployment again. If this does not help, feel free to [ask](https://app.slack.com/client/T0140N4DP36) for additional help.
