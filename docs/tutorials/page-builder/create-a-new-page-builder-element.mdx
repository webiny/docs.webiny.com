...
You can find the full example with all required code [in the example folder here](https://github.com/webiny/webiny-examples/tree/master/iframe-page-element/packages/iFrameElement)
...
The settings UI will be shown automatically in the right sidebar when the user drags and drops the page element on the page.
