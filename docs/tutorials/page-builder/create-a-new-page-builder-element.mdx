...
const IFrameEmbed = props => {
    ...
    return (
        <ElementRoot
            className={
                "webiny-pb-base-page-element-style webiny-pb-page-element-iframe " +
                outerWrapper
            }
            element={element}
        >
...
Similar approach can be used to easily create a whole array of custom elements for Page Builder app.