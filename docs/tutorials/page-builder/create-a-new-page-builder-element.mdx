...
- Create a `package.json` file inside `apps/extensions/pb-element-iframe` with the following contents:
...
Congratulations! We've successfully created a new page element for our Page Builder app.
Use similar approach to easily create a whole array of custom elements for Page Builder app.

You will find the full code example in our webiny examples [repo](https://github.com/webiny/webiny-examples/tree/master/iframe-page-element).
