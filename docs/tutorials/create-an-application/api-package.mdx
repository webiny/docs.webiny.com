...
Name of the API data model. The GraphQL queries, mutations, responses, and variable names in the code will use this value in singular and plural, kebab-case, camel-case or some other form.
...
If you want to use the Elasticsearch functionality, that is provided with the generated code, you must run install mutation described in the information after the code was generated. This will create the Elasticsearch index for your data.
