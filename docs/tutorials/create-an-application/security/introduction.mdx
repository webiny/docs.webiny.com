...
Feel free to copy and paste the shown code into your project and use it as a starting point. Note that the `permissions` folder is a new folder that we created, it wasn't initially there.
