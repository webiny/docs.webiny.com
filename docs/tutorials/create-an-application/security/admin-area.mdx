...
```tsx title="packages/car-manufacturers/admin-app/src/menus.tsx" {4,6,7,9,10,16-39}
...
#### In the last part, could I use the `useSecurity` React hook instead of the `SecureView` React component?

Yes, you could certainly do that. In the last section of this tutorial, we used the `SecureView` component mainly for demonstration purposes and to raise awareness of its existence.
