...
* how can you modify the data that is indexed
* how can you modify the data that is stored
:::
...
Tutorial example files are located in our [example repository](https://github.com/webiny/webiny-examples/tree/master/headless-cms/address-field).