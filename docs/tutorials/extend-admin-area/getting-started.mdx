...
Once the two watch sessions have been started, in our Admin Area, we should be able to see the new **Car Manufacturers** module and, via the generated [CRUD view](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area/#new-webiny-admin-area-module), perform essential CRUD operations.

<CenteredImage shadow={false} alt="New Car Manufacturers Module" src={scaffoldsAdminArea}/>

:::tip
By default, the Admin Area React application should be locally accessible via [http://localhost:3001](http://localhost:3001).
:::
