...
- in the Admin Area application: a new route, menu item, and a [CRUD view](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area#new-webiny-admin-area-module)
...
Once the two watch sessions have been started, in our Admin Area application, we should be able to see the new **Car Manufacturers** module and, via the generated [CRUD view](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area/#new-webiny-admin-area-module), perform essential CRUD operations.
