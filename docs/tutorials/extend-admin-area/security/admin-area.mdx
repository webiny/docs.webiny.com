...
By completing the [previous set of tutorials](/docs/tutorials/extend-admin-area/introduction), in our Webiny Admin Area, we should have the following items in the main menu:
