...
:::info
The code that we will cover in this tutorial can also be found in our [GitHub examples repository](https://github.com/webiny/webiny-examples/tree/master/extend-admin-area/securing-your-application/code/packages/car-manufacturers/admin-app).
:::
...
By completing the previous [Admin Area Package](/docs/tutorials/extend-admin-area/admin-area-package) tutorial, in our Webiny Admin Area, we should have the following items in the main menu:
...
:::tip
If you're curious about the `CarManufacturersPermission` type, check its definition in [packages/car-manufacturers/admin-app/src/types.ts:24](https://github.com/webiny/webiny-examples/tree/master/extend-admin-area/securing-your-application/code/packages/car-manufacturers/admin-app/src/types.ts#L24).
:::
