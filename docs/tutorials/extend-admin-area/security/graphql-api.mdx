...
At the moment, the `carManufacturers` queries and mutations, that we added to our main GraphQL API in the [API Package](/docs/tutorials/extend-admin-area/api-package) tutorial, are publicly exposed.
