...
import updatePinMutationCannotUpdateOtherUsersPin from "./implementing-authentication-and-authorization-logic/update-pin-cannot-update-other-users-pin.png";
import updatePinMutationCreateWithUser from "./implementing-authentication-and-authorization-logic/update-pin-create-with-user.png";
import updatePinMutationUpdateWithUser from "./implementing-authentication-and-authorization-logic/update-pin-update-with-user.png";
...
<CenteredImage alt={'"UpdatePin" Mutation - Not Authorized'} src={updatePinMutationCannotUpdateOtherUsersPin} />
