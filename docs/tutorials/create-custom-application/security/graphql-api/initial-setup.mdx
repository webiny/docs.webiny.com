...
## Updating Cloud Infrastructure Code
...
```ts title="pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/entities/Pin.ts:30" {25}
...
```ts title="pinterest-clone/api/code/graphql/src/plugins/scaffolds/pins/types.ts" {6,19}
