...
<CenteredImage alt="User Authentication Flow Start" shadow={false} style={{ maxWidth: 500 }} src={hostedUi1} />
...
<CenteredImage alt="User Authentication Flow End" shadow={false} style={{ maxWidth: 500 }} src={hostedUi2} />
...
```ts title="pinterest-clone/app/code/webiny.config.ts" {3,13-15,23,30}
