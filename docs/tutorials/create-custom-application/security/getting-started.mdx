...
With this approach, the authentication flow is completely offloaded to Amazon Cognito. Once a user wishes to sign up or sign in to our application, she/he usually clicks on a button or a link, which causes a redirect to the standalone hosted authentication flow. So, as mentioned, the authentication flow is happening completely outside of our application.
