...
import preview from "./introduction/preview.png";
...
Additionally, on the frontend side, for anything styling-related, we'll use [Sass](https://sass-lang.com/), which is already included in every Webiny project. We'll also use the [Ant Design React library](https://ant.design/docs/react/introduce) to create the majority of the user interface. For both of these, a basic understanding will suffice.
