---
id: full-stack-application-scaffold
title: Initial Setup With Full Stack Application Scaffold
sidebar_label: Initial Setup With Full Stack Application Scaffold
...
Once the two watch sessions have been started, we can start building our application. In the next section, we'll start by extending the GraphQL API with a basic set of [CRUD](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete) GraphQL query and mutation operations.
