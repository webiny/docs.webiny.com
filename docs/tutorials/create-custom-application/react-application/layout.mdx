...
:::info
The code that we will cover in this section can also be found in our GitHub [examples repository](https://github.com/webiny/webiny-examples/tree/master/create-custom-application/04-react-application/04.01-layout). If you want to see the final code of the application we're building in this tutorial, check out the [`full-example`](https://github.com/webiny/webiny-examples/tree/master/create-custom-application/full-example) folder.
:::
...
:::note
In order for the above code to work, make sure to copy and paste the [`logo.png`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/images/logo.png) file into the [`pinterest-clone/app/code/src/images`](https://github.com/webiny/webiny-examples/tree/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/images) folder.
:::

:::tip
Notice how we've used the tilde (`~`) character to target the parent [`images`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/images) folder upon importing the [`logo.png`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/images/logo.png) image. Using that instead of something like `../../../` can make our import statements easier to read and maintain.
:::

For now, this code will only render the [application logo](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/images/logo.png) on the left side of the header. The **New Pin** and **User Menu** on the right, shown in the above layout diagram, will be added later, in the upcoming sections of this tutorial.
...
An optional step that we could take here is cleaning up the [`Home`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home.tsx#L7) component, located in the [`pinterest-clone/app/code/src/plugins/routes/home.tsx`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home.tsx) file, and removing the [`UsefulLink`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home/UsefulLink.tsx#L10) and [`UsefulLinks`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home/UsefulLinks.tsx#L9) components, located in the [`pinterest-clone/app/code/src/plugins/routes/home`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home) folder.

All of these files were created during the scaffolding process, and basically they are irrelevant for our application. Alternatively, you could also move these files into a separate backup folder of your choice, possibly for future reference.

Once cleaned up, the [`Home`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.01-layout/pinterest-clone/app/code/src/plugins/routes/home.tsx#L7) component might look something like the following:
