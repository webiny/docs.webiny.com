...
Unlike with the **Homepage**, where we already had some code in the already existing [`home.tsx`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/plugins/routes/home.tsx) file, for the **Pin Details** page, we'll need to create a new [`pinDetails.tsx`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/plugins/routes/pinDetails.tsx) file. The file will contain the [`PinDetails`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/plugins/routes/pinDetails.tsx#L33) React component which we'll export via a new [`RoutePlugin`](https://github.com/webiny/webiny-js/blob/v5.14.0/packages/app/src/plugins/RoutePlugin.tsx#L8) plugin:
...
One last step we need to take here is register the exported [`RoutePlugin`](https://github.com/webiny/webiny-js/blob/v5.14.0/packages/app/src/plugins/RoutePlugin.tsx#L8) plugin in the [`pinterest-clone/app/code/src/plugins/index.ts`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/plugins/index.ts). We can do that like so:
...
So let's create a new [`pinDetails.scss`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/styles/pinDetails.scss) file in [`pinterest-clone/app/code/src/styles`](https://github.com/webiny/webiny-examples/blob/master/create-custom-application/04-react-application/04.04-pin-details-page/pinterest-clone/app/code/src/styles) and paste the following code into it:
