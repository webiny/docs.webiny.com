...
The [Extend GraphQL API](/docs/how-to-guides/webiny-cli/scaffolding/extend-graphql-api) and [Extend Admin Area](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area) scaffolds, which can help you extend your GraphQL API in no time, use the same concepts and approaches that are explained in this guide.
...
:::tip
To extend your default GraphQL API in no time, make sure to try the [Extend Admin Area](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area) and [Extend GraphQL API](/docs/how-to-guides/webiny-cli/scaffolding/extend-graphql-api) scaffolds.
:::
