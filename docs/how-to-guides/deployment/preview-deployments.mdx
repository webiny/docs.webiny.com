...
## FAQ
**Does the preview flag work with the [`deploy`](/docs/how-to-guides/deployment/deploy-your-project#the-deploy-command) command?**

The preview flag only works with the `app deploy` command, shown in this guide.
