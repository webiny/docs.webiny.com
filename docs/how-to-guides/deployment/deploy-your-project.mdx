...
If you didn't install the Pulumi CLI manually by yourself, which is usually the case for most Webiny users, you can execute the above commands via the [Webiny CLI](/docs/key-topics/webiny-cli), for example:
