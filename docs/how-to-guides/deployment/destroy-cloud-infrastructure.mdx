...
This command lets you destroy cloud infrastructure previously deployed within a [project application](/docs/key-topics/project-applications). <!-- This can be handy if you want to avoid completely destroying all cloud infrastructure that was deployed by the default project applications, which is what the shown `destroy` command does. -->
