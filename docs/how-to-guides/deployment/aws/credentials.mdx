...
You can do this by clicking [create stack](https://console.aws.amazon.com/cloudformation/home?#/stacks/create/review?templateURL=https://cf-templates-16wmwt5xsvalh-ap-southeast-1.s3.ap-southeast-1.amazonaws.com/CWP_POLICY_CLOUDFORMATION_TEMPLATE.json&stackName=Create-webiny-project):
