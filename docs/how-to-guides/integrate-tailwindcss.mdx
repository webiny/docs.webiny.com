...
In this guide, we integrate Tailwind CSS in the **Website** project application's React application `(apps/website)`.
...
let's try adding an example section made with Tailwind CSS as shown below:
...
#### Can I include the Tailwind CSS directives in Website `(app/website)` React application directly?
