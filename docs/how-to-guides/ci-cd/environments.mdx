...
:::info
This structure of environments is also mirrored by branches in your project's Git repository. More on this in the [Branching](/docs/how-to-guides/development-workflows/branching) guide that follows.
:::
...
Best practice is to use multiple AWS accounts. More on this topic can be founds in the [CI/CD](/docs/how-to-guides/development-workflows/ci-cd) guide.
