...
:::info
Environment variables can be assigned in a couple of ways. Check out the [Environment variables](/docs/how-to-guides/environment-variables) guide to learn more.
:::
