...
This is mainly because of the [Create React App](https://create-react-app.dev/docs/adding-custom-environment-variables/), which is being utilized as a frontend application development tool.