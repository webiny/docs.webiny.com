...
:::tip
If you already have the [watch](/docs/how-to-guides/webiny-cli/use-watch-command/#webiny-watch-command) running, the new import will be picked up, built, and deployed to the cloud automatically.
