...
- how to continue developing on top of the generated code

:::

## Overview

The **Extend GraphQL API** scaffold extends your project's GraphQL HTTP API with new CRUD query and mutation operations.
...
The generated code follows the same idea. There aren't any additional steps that need to be taken in order to enable multi-locale support.
...
Please check out the [existing tutorials](/docs/tutorials/create-an-application/security/introduction) to learn how to implement these on your own.
