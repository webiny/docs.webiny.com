...
Of course, if additional cloud infrastructure resources are needed, you're free to amend the [existing cloud infrastructure code](https://github.com/webiny/webiny-js/tree/v5.9.0/packages/cwp-template-aws/template/api/pulumi), and reference the added and deployed resources in your application code.
...
#### How does security (authorization and authentication) work?
