...
:::info
Learn how to deploy your project into multiple environments with the [`deploy`](http://localhost:3000/docs/how-to-guides/deployment/deploy-your-project) command.
:::
