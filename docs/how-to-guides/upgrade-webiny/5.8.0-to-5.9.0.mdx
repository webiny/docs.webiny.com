...
This change is needed simply because of the fact that the `@webiny/api-security-tenancy` package doesn't exist anymore. Note that the new `@webiny/api-tenancy` package should already exist in your project. No need to add it manually.
