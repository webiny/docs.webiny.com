...
Finally, proceed by re-deploying the **API** project application:
...
:::info
The following only apply to users who have created custom Elasticsearch plugins in their code.
:::
