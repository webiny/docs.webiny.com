...
Due to some internal changes in how we store data to the database you must add new plugins to the Headless CMS API index.ts file.
...
Then you need import new plugin from the new `@webiny/api-headless-cms-ddb-es` package.
