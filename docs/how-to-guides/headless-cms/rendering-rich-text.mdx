---
id: rendering-rich-text
title: Rendering Rich Text Content
sidebar_label: Rendering Rich Text Content
keywords: ["headless", "cms", "rich text", "editorjs"]
...
:::info
To learn how to use Headless CMS GraphQL API, make sure to check out the [Using GraphQL API](/docs/how-to-guides/headless-cms/using-graphql-api) key topic.
:::

## Rendering Rich Text Content

To render rich text content created with editorjs in your React app, Webiny provides a package `@webiny/rich-text-renderer` with a React component to do just that.
...
The rendering implementation is really simple and straightforward. You can find the [full code in our repo](https://github.com/webiny/webiny-js/blob/next/packages/rich-text-renderer/src/index.tsx). Using that as a reference, you can quickly put together a renderer in the framework of your choice.
