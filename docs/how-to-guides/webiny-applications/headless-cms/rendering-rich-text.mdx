...
:::info
To learn how to use Headless CMS GraphQL API, make sure to check out the [Using GraphQL API](/docs/how-to-guides/webiny-applications/headless-cms/using-graphql-api) key topic.
:::
