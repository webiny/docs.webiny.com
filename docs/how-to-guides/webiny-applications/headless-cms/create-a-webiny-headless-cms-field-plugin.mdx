...
:::info
In this guide, we assume that you know how Webiny plugins work. If not, please visit the [Plugins](/docs/key-topics/plugins) key topic article, to get yourself familiar with the concepts.
:::
