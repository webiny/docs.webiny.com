...
:::info Prerequisites
To use the instructions presented in this guide, you need to know how to register Webiny plugins. Please visit the [Importing Plugins](/docs/how-to-guides/development/importing-plugins) guide, if you're not already familiar with the process.
:::
