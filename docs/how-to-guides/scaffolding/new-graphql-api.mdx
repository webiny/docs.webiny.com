...
Except for the application and cloud infrastructure code, the scaffold also generates the necessary [Jest](/docs/key-topics/tools-libraries#testing) configuration and foundation for testing the GraphQL API functionality you'll be building. The already mentioned [Extend GraphQL API](/docs/how-to-guides/webiny-cli/scaffolding/extend-graphql-api) scaffolds takes advantage of this and immediately creates a couple of example tests you can use for reference.
