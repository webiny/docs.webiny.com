...
More information on different databases and this dual cloud infrastructure setup can be found in the [Development](/docs/how-to-guides/scaffolding/new-full-stack-application#development) section below.
