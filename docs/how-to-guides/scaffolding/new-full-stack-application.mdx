...
The **New Full Stack Application** scaffold extends your project's GraphQL HTTP API with a new [CRUD](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete) query and mutation operations.
...
The **New Full Stack Application** extends your GraphQL API with two query and three mutation operations.
