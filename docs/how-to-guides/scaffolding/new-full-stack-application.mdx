...
The **New Full Stack Application** scaffold creates a new full stack application which consists of a simple React application and the supporting GraphQL HTTP API.
