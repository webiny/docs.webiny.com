...
## AI-programmability as a design constraint

Since 2025, every new feature we build is also evaluated through the lens of AI-programmability. We ask: can an AI coding agent, given the right context, generate a correct extension for this feature? Does the API surface use consistent, typed patterns? Are the extension points documented in a way that both humans and AI agents can consume?

This constraint has made our features better for everyone. What makes a feature easy for AI to work with — explicit types, predictable patterns, clear documentation — also makes it easier for human developers. It's a forcing function for good design.
