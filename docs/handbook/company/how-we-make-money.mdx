...
We love technical selling, so even if you start off talking business, we love getting in front of your engineering team and doing hour-long technical deep dives, opening the code, doing live coding demos and similar. We want to make sure that you understand our product and that it's a good fit for your project.
...
- ** Cost efficiency ** - The cost model of serverless infrastructure is that you pay per usage. This means that you only pay for what you use, you never overpay or underpay. In practice, Webiny can lower your infrastructure costs by up to 80% compared to traditional hosting solutions.
...
We can do this because of our self-hosted nature. Our pricing model is not "baked" into our code as you find in most SaaS products. We can easily change it to fit your needs. Our goal is to price you based on the value you're getting out of the product. 
