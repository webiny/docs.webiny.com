...
We have a dual-license model. This means that we offer our software under two different licenses: a commercial license and an open-source license. You can read more about our license model and pricing tiers [here](https://www.webiny.com/pricing).
