...
Around 2017/18 Sven started to play around with serverless technologies, which were still in very early stages. That vision of serverless, in how we saw it then, and how we still see it today remained the same - _serverless is the future of infrastructure_.
...
DXP is a product that caters for end to end needs of large enterprises in terms of creating and distributing their content. We're talking about everything from email marketing, personalization, e-commerce and much more.

## AI-Programmable CMS — 2026

The release of capable AI coding agents changed the game for developer platforms. We noticed something: the same architecture that made Webiny great for human developers — typed TypeScript APIs, consistent factory patterns, explicit extension points, code-as-configuration — also made it remarkably easy for AI agents to generate correct, platform-native code.

We leaned into this. Webiny v6 shipped with a built-in MCP (Model Context Protocol) server that gives AI agents structured knowledge about every part of the platform. Developers could now describe what they wanted — a content model, a lifecycle hook, a custom API — and have their AI agent produce working, upgrade-safe code in seconds.

This wasn't a pivot. It was the natural consequence of years of investing in developer experience and principled architecture. Webiny became the world's first AI-programmable CMS: a platform designed from the ground up for humans and AI agents to build together.

## Webiny — The leading AI-programmable CMS — 2030

This part of our story is yet to be written, but we firmly believe our unique product proposition — an open-source, self-hosted, AI-programmable content platform — mixed with our strong customer-centric culture backed by our open-source community and a vast network of agency partners will enable us to build a product that can bring a long-needed change to the CMS market that's currently controlled by a small handful of outdated solutions.
