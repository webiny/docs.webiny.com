...
In case we don't commit your item to the roadmap, we will always provide you with a workaround or a solution that will get you unblocked. Typically this means adding new extension points, hooks and lifecycle events, followed by a set of tutorials that will enable your team to implement the feature themselves.