...
:::info
Learn more about the fundamental organizational units - project applications and packages, by visiting the [Project Organization](/docs/key-topics/project-organization) page.
:::
