...
For the next topic we would suggest reading about [content model lifecycle hooks](./lifecycle-hooks/content-models.mdx) and [content entry lifecycle hooks](./lifecycle-hooks/content-entry.mdx).