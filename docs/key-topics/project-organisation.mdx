...
keywords: ["webiny", "project", "organisation", "packages", "applications"]
description: Learn about fundamental organisational units of every Webiny project.
---
...
<!--
## Webiny Project
Everything starts with a **Webiny project**, which is what gets created for you (on your local file system) in the [Webiny Installation](/docs/tutorials/install-webiny) process. This is the top organisational unit, which is made of packages and project applications.
-->
...
**Does Webiny enforce a strict files and folders organisation?**
