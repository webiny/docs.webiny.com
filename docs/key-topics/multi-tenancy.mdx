...
:::danger Enterprise-only feature
Multi-tenancy is a feature that requires an enterprise license.
:::
...
Multi-tenancy is an architecture which allows you to serve multiple customers, called `tenants`, using a single instance (deployment) of your software. It is particularly interesting in the context of _serverless_ since you don't have to worry about scaling your infrastructure as the number of tenants grows.

Usually tenants share storage (database). However, they can also have dedicated storage assigned to them in case they're consuming a significant amount of storage compared to other tenants.

In the serverless world, this is less of a problem as databases scale automatically, and you don't need to worry about your shared database running out of storage space.
...
---
TODO: add a link to a guide/tutorial on custom user management implementation
