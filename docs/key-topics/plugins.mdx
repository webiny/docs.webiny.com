...
:::info
This article gives a theoretical explanation of the concept. If you're looking for instructions on practical usage, please refer to the [Importing Plugins](/docs/how-to-guides/development/importing-plugins) article.
:::
