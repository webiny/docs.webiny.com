...
- [colors](/docs/key-topics/webiny-applications/themes/page-builder/colors)
- [elements](/docs/key-topics/webiny-applications/themes/page-builder/elements)
...
To learn more about layouts and how to compose one, have a look at the [layouts article](/docs/key-topics/webiny-applications/themes/page-builder/layouts).
