...
1. UX is not good because every time a user opens a page, he's presented with a loading screen.
...
So, the cloud infrastructure contains additional resources and it also depends on the **API** project application, which hosts the mentioned **Prerendering service** and which coordinates the whole process. All this, and more, is examined in the diagrams below.
