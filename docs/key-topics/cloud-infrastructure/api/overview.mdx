...
:::info
All of the shown cloud infrastructure resources are deployed into a single AWS region, which is defined by you. Check out the [AWS Regions and Profiles](/docs/how-to-guides/deployment/aws-regions-profiles) guide for more information.
:::

The Webiny applications in question are:
