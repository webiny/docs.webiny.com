...
So, the cloud infrastructure contains additional resources and it also depends on the **API** project application, which hosts the mentioned **Prerendering service** and which coordinates the whole process. All this, and more, is examined in the following topics.
