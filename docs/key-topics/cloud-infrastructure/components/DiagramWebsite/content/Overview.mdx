...
The diagram gives an overview of the complete cloud infrastructure that's needed to host the **Website** project application and, in combination with the **API** project application, makes prerendering of pages possible.
