...
Builds all of the project application packages and deploys cloud infrastructure resources defined within, into the specified environment.
...
Returns a couple of useful URLs, for example, the URL over which the deployed GraphQL API can be accessed.
