...
:::info
For best practices on how to organize your environments and other workflows, check out the [Workflows](https://www.webiny.com/docs/key-topics/ci-cd/workflows/) section.
:::
...
Deploying multiple project environments into the same AWS account may incur additional cost. Check out the [Cloud Infrastructure](https://www.webiny.com/docs/key-topics/cloud-infrastructure/introduction) section for more information.
:::
