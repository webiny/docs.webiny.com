...
As explained in the [project organization](/docs/key-topics/project-organization) section, every Webiny project can consist of one or more project applications. Furthermore, every project application consists of [application code and the necessary infrastructure](/docs/key-topics/project-applications) that's needed in order to run it.
