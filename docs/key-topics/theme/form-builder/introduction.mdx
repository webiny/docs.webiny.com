...
- what is Form Builder theme
- how theme is used in Form Builder
...
:::info
You can also insert the forms created in Form Builder into a page using the Page Builder app.
:::
