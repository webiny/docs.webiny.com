...
This ensures a visual consistency between the theme and users creating content.
...
[style inheritance](/docs/webiny-apps/page-builder/development/themes/style-inheritance).
...
Let's update the theme colors by updating the `Sass` variables.
Make the following changes in the [variables.scss](https://github.com/webiny/webiny-js/blob/next/apps/theme/pageBuilder/styles/variables.scss) file:
...
//...
```
After making these changes the Page Builder elements reflect the updated colors as shown below:
<!-- vale off -->
