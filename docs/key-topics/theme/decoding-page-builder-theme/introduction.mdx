...
- [colors](/docs/key-topics/theme/decoding-page-builder-theme/colors)
- [elements](/docs/key-topics/theme/decoding-page-builder-theme/elements)
...
To learn more about layouts and how to compose one, have a look at the [layouts page](/docs/key-topics/theme/decoding-page-builder-theme/layouts).
