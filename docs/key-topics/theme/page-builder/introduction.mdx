...
<!-- TODO: Expand on what is a layout. Say that for example, you might have two layouts.. one with the main menu, the other one with a main menu and additional banner.. or maybe even better.. one layout where the page is rendered in two-columned, the other in three columned layout. -->
...
<!-- TODO: Replace image with a screenshot on a smaller screen size. -->
<!-- vale off -->
...
:::info
Layouts link to page categories. When you create a page category, say "Blog", you need to select a layout inside which that content display.
...
To learn more about layouts and how to compose one, have a look at the [layouts article](/docs/key-topics/theme/page-builder/layouts).
