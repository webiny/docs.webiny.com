...
- how to create your custom layout and use it in a page
:::

## Overview
A layouts define the content hierarchy. It is a pattern that defines a website’s structure. It provides clear paths for navigation within webpages and puts the most important elements of a website front and center.

The most commonly used layout consists of three parts:
...
Each page created inside the "Blog" category, by default, will use that layout.
