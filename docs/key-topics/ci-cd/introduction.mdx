...
:::info
In the rest of this key topics section, when mentioning the **CD** abbreviation, we're explicitly referring to **continuous deployment**.
:::
