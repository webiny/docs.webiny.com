...
:::note
By default, the mentioned [`PULUMI_SECRETS_PROVIDER`](https://github.com/webiny/webiny-js/blob/v5.15.0/packages/cwp-template-aws/template/example.env#L6) and [`PULUMI_CONFIG_PASSPHRASE`](https://github.com/webiny/webiny-js/blob/v5.15.0/packages/cwp-template-aws/template/example.env#L10)  are, respectively, set to `passphrase` and a random string, in the [`.env`](https://github.com/webiny/webiny-js/blob/v5.15.0/packages/cwp-template-aws/template/example.env#L4-L10) file, located in your project root.
:::

:::info
Learn more about secrets and secret providers in [Pulumi's official documentation](https://www.pulumi.com/docs/intro/concepts/secrets/).
:::
