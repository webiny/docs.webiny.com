...
:::info
Environment variables can be assigned in a couple of different ways. Check out the [Environment Variables](/docs/how-to-guides/environment-variables) guide to learn more.
:::
