...
1. [Entry List Filters](/docs/{version}/headless-cms/extending/customize-entry-list-filters)
2. [Entry Editor Actions](/docs/{version}/headless-cms/extending/customize-entry-editor-actions)
