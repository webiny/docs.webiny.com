...
A couple of minor fixes and improvements were made to the [scaffolding utilities](/docs/how-to-guides/scaffolding/introduction), introduced in the previous [Webiny 5.9.0](/docs/changelog/5.9.0) release.
