...
New projects created with v5.23.\* will use Node 14 runtime for the Lambda functions. Note that existing projects will not be upgraded, as this is not a crucial update, and everything works just fine with node 12. You _can_, however, manually update your babel configs and Pulumi configs if you want to use Node 14 in your existing project.
