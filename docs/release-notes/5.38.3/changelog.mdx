...
With this release, we are preventing the user from accidentally closing the “Bulk Edit” dialog by disabling the default behaviour of closing the dialog when clicking on the scrim.
