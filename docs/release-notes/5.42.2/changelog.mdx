...
With the 5.42.0 release, a regression was introduced that caused validation issues when saving changes in the Form Builder's form editor and also using the Terms of Service feature. 
