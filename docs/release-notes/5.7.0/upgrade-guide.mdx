...
Make sure to check out the [5.7.0 changelog](/docs/{version}/release-notes/5.7.0/changelog) to get familiar with all the changes introduced in this release.
...
Now you're ready to redeploy your API and apps. By now, you're most likely familiar with the deployment process, but if you need a refresher, visit our [Deploy Your Project](/docs/{version}/core-development-concepts/basics/project-deployment) guide for everything related to deployments.
