...
The extension can be accessed like any other extension, via the [`webiny extension`](/docs/{version}/core-development-concepts/basics/webiny-cli#yarn-webiny-extension) command, by then selecting **Page Builder Element** from the list of all available extensions.
