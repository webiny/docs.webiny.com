...
To find out more about the advanced filtering, read this [article](/docs/{version}/headless-cms/basics/using-graphql-api-advanced-filtering).
...
To find out how to add your own error handler, please read [this article](/docs/{version}/core-development-concepts/extending-and-customizing/customizing-the-error-output).
