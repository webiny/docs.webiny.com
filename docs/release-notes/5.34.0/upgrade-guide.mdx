...
Make sure to check out the [5.34.0 changelog](/docs/{version}/release-notes/5.34.0/changelog) to get familiar with the changes introduced in this release.
...
As stated in the [Upgrade Webiny](/docs/{version}/release-notes/5.34.0/upgrade-webiny#pre-production-environments-first) section, we recommend that you first deploy your changes into one of your pre-production environments, like `dev` or `staging`.
