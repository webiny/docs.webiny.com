...
Make sure to check out the [5.36.0 changelog](/docs/{version}/release-notes/5.36.0/changelog) to get familiar with the changes introduced in this
release.
...
As stated in the [Upgrade Webiny](/docs/{version}/release-notes/5.36.0/upgrade-webiny#pre-production-environments-first) section, we recommend that you
