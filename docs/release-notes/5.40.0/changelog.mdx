...
To customize how long deleted entries are kept, developers can adjust two environment variables. For instance, if you want to set the retention period to 7 days, follow these steps:
...
If you set both variables to 0, the default retention period will be used.
