...
During the upgrade process, your existing `global.scss` will be automatically backed up and replaced with the new one. This ensures that you don't lose any customizations you might have made to the `global.scss` file and that you can easily re-apply them to the new file.
