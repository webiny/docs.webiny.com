...
<Alert type={"warning"}>
  This improvement was already released with the 5.39.9 release. With this release, we've just made sure it's also included in the 5.40.x and all future releases.
</Alert>
