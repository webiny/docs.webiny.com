...
### Export Import Page ([#1960](https://github.com/webiny/webiny-js/pull/1960))

Now you can export pages created by the Page Builder editor. You can also choose whether to export the published or latest revision:

<CenteredImage alt='Page Builder - export page demo' src={exportPageUI} style={{maxWidth: 750}}/>

And, then you can import it (most likely in a different webiny project) by simply clicking the **Import Page** button and providing the exported file:
