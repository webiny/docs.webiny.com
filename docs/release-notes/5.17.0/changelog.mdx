...
import revisionsMenu from "./revisions-menu.png";
import tenantManager from "./tenant-manager.png";
import oktaLogin from "./okta-login.png";
import eventsAutocomplete from "./events-autocomplete.png";
import accessManagement from "./access-management.png";
import gridWidth from "./grid-witdh.gif";
...
Instead of creating a new plugin type for every entity, events are defined on the application level (in the `context` object) and are easily discoverable in any IDE:
