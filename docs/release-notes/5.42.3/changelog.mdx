...
- [Adding custom fields to Page Builder folders](/docs/{version}/file-manager/extending/customize-folder-fields)
- [Adding custom fields to File Manager folders](/docs/{version}/page-builder/extending/customize-folder-fields)
