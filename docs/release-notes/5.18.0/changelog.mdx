...
### Add Caching for OPTIONS Request ([#2025](https://github.com/webiny/webiny-js/pull/2025))

We've added CDN level caching for the `OPTIONS` request, which means you will now get faster response time across the whole API.