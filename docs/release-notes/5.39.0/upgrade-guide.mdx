...
- Effect: Allow
  ...
  # Be careful about the wby-* resource name. If you're using a custom Pulumi 
  # resource name prefix, you'll need to update this accordingly. For more 
  # information on custom Pulumi resource name prefixes, see:
