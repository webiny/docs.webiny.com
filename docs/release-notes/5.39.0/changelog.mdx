...
[//]: # (| `modifiedOn`               | NEW The date/time when an entry revision was created.                                 |)

[//]: # (| `savedOn`                  | The date/time when an entry revision was last saved.                                  |)

[//]: # (| `publishedOn`              | DELETED The date/time when an entry revision was published.                           |)

[//]: # (| `firstPublishedOn`         | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `lastPublishedOn`          | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `createdBy`                | The identity of the user who created an entry revision.                               |)

[//]: # (| `ownedBy`                  | DELETED The identity of the user who owns the entry &#40;who created the first revision&#41;. |)

[//]: # (| `modifiedBy`               | The identity of the user who last modified an entry revision.                         |)

[//]: # (| `firstPublishedBy`         | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `lastPublishedBy`          | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `revisionCreatedOn`        | The date/time when an entry revision was created.                                     |)

[//]: # (| `revisionModifiedOn`       | NEW The date/time when an entry revision was created.                                 |)

[//]: # (| `revisionSavedOn`          | The date/time when an entry revision was last saved.                                  |)

[//]: # (| `revisionFirstPublishedOn` | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `revisionLastPublishedOn`  | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `revisionCreatedBy`        | The identity of the user who created an entry revision.                               |)

[//]: # (| `revisionModifiedBy`       | The identity of the user who last modified an entry revision.                         |)

[//]: # (| `revisionSavedBy`          | The identity of the user who last modified an entry revision.                         |)

[//]: # (| `revisionFirstPublishedBy` | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # (| `revisionLastPublishedBy`  | NEW The identity of the user who last modified an entry revision.                     |)

[//]: # ()
[//]: # (In total, we're introducing 20 new meta fields, where 10 are revision-specific, and 10 are entry-specific.)
...
For more information on all of these topics, be sure to check out the [Upgrade Guide](/docs/release-notes/5.39.0/upgrade-guide) section and, more importantly, the [Date/Time and Identity (On/By) Meta Fields](/docs/release-notes/5.39.0/date-time-and-id-meta-fields) article.
