...
### Deployments - New IAM Permissions (Allowed Actions) Required
...
For additional information, please refer to the [Deployments - New IAM Permissions (Allowed Actions) Required](/docs/release-notes/5.39.0/deployments-new-iam-permissions-required) upgrade guide.
