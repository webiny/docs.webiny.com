...
- [GraphQL API](/docs/{version}/core-development-concepts/scaffolding/extend-graphql-api)
...
The existing guides that cover extending GraphQL APIs were also updated, so make sure to [check them out](/docs/{version}/core-development-concepts/extending-and-customizing/extend-graphql-api) to learn more:
...
Check out the [Use AWS Profiles](/docs/{version}/infrastructure/aws/use-aws-profiles) how-to guide to learn how to use different AWS profiles upon deploying your Webiny project.
