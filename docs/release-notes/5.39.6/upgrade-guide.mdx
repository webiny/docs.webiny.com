---
id: 809a794e
title: Upgrade from 5.38.x to 5.39.6
description: Learn how to upgrade Webiny from 5.38.x to 5.39.6.
---
...
<Alert type="success" title="What you’ll learn">
  ...
  - how to upgrade Webiny from 5.38.x to 5.39.6

</Alert>

<Alert type="info">

  Make sure to check out the [5.39.6 changelog](./changelog) to get familiar with the changes introduced in this
  release.
...
In case you are upgrading to **5.39.6** from **5.38.x**, you must upgrade your project. Depending on your project, you might also need to perform a couple of manual steps.
