...
Please read the **Upgrading CMS Model Plugin Definitions** of [this](/docs/{version}/headless-cms/extending/content-models-via-code-storage-id#upgrading-cms-model-plugin-definitions) article.
