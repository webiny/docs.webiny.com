...
As mentioned in the [changelog](/docs/release-notes/5.11.0/changelog), from the 5.11.0 release, all Webiny projects will use [Pulumi](/docs/{version}/infrastructure/pulumi-iac/iac-with-pulumi) v3.
