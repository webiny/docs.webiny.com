...
On the other hand, if you’re coming with an older version of Webiny, before upgrading, make sure to check our [How To Upgrade](/docs/{version}/release-notes/upgrade-webiny) guide.
