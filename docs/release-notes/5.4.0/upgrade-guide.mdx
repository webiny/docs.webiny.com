...
Make sure to check out the [5.4.0 changelog](/docs/{version}/release-notes/5.4.0/changelog) to get familiar with all of the changes introduced with this release.
...
Check out the [Cloud Infrastructure](/docs/{version}/architecture/website/prerendering-pages) key topics section to learn more about all of the resources included in the process.
