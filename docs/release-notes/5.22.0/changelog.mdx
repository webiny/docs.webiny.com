...
### Added `react-refresh` ([#2101](https://github.com/webiny/webiny-js/pull/2101))

We added [react-refresh](https://www.npmjs.com/package/react-refresh) module for better hot module reloading and development experience
in our React applications.

### Simplified Babel Configuration ([#2101](https://github.com/webiny/webiny-js/pull/2101))

We removed a requirement to have `babel-plugin-named-asset-import` in project's Babel configuration.
It can also be safely deleted from project dependencies.
