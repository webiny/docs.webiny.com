...
After some testing on our side, we've discovered that updating versions of relevant NPM packages resolves the issue. So, with this release, we've update the versions of the following NPM packages:
...
All in all, with all of the versions upgraded, the Page Builder's page rendering functionality should start working as expected.
