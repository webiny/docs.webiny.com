...
This document highlights the most important fixes, improvements, and features, that were introduced in Webiny `5.19.0`.

:::info How To Upgrade?
Please check the [Webiny 5.19.0 migration guide](/docs/release-notes/5.19.0/upgrade-guide) for the upgrade steps.
:::
...
For more information on this change, make sure to check out the [Additional Information](/docs/release-notes/5.19.0/upgrade-guide#additional-information) section in the [Upgrade Guide](/docs/release-notes/5.19.0/upgrade-guide).
