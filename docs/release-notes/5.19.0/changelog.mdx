...
In order to use the [`webiny deploy`](/docs/how-to-guides/deployment/deploy-your-project) command, AWS credentials need to be set, which can be done in [multiple ways](/how-to-guides/deployment/aws/configure-aws-credentials).
