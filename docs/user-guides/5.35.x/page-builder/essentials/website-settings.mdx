...
1. Under the **Default Pages** section, in the **Homepage** dropdown, select the page *you want as the homepage* (e.g. **The benefits of a Serverless CMS** - the page we created in the [Create Page](/docs/{version}/user-guides/essentials/create-page) tutorial).
