...
To follow this tutorial, you need a page in the Page Builder to import. If you don't have a page, please follow the [Create Page](/docs/{version}/user-guides/essentials/create-page) tutorial to create it.

## Step 1: Export a Page

In this step, we will export the **The benefits of a Serverless CMS** page we created in the [Create Page](/docs/{version}/user-guides/essentials/create-page) tutorial.
