...
As an example, we will add validators to the **LONG TEXT** and **NUMBER** fields used in the **Product** content model that we created in the [Create Content Model](/docs/{version}/user-guides/headless-cms/essentials/create-content-model) tutorial.
