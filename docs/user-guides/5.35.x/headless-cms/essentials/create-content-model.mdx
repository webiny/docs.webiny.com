...
In this tutorial, we will learn how to create a [content model](/docs/{version}/user-guides/essentials/glossary#content-model).
...
we will define model [fields](/docs/{version}/user-guides/essentials/glossary#field-field-type).
