...
As an example, we will update the description of **Product** content model that we created in the [Create Content Model](/{version}/user-guides/headless-cms/essentials/create-content-model) tutorial.
