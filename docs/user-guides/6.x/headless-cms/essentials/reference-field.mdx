...
If you are not familiar with how to create a content model, please follow the [Create Content Model](/{version}/user-guides/headless-cms/essentials/create-content-model) tutorial.
