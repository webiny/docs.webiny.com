...
In this tutorial, we will learn how to create a [content model](/{version}/user-guides/headless-cms/essentials/glossary#content-model).
...
we will define model [fields](/{version}/user-guides/headless-cms/essentials/glossary#field-field-type).
