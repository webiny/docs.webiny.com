...
import importExportContentModel from "./assets/import-export-content-models/import-export-content-models.mp4";
...
<Video src={importExportContentModel} controls={true} />
