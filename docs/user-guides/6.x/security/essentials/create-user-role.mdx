...
import roleCreationVideo from "./assets/create-user-role/create-user-role.mp4";
...
To follow this tutorial, you need to have a content model group named **E-commerce** in your Webiny instance. If you don't have it, please follow the [Create Content Model Group](/{version}/user-guides/headless-cms/essentials/create-content-model-group) tutorial to create it.
