...
To follow this tutorial, you need to have the **E-commerce** user role in your Webiny instance. If you don't have it, please follow the [Create Role](/{version}/user-guides/security/essentials/create-user-role) tutorial to create it.
