...
Webiny enables you to add several users with varying access in your application. You can define the access permissions for a specific group of users by creating a Role.
