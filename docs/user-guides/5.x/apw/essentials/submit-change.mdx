...
- You need to have the change request **Change blog's title for better SEO** made by a reviewer. If you don't have it, please follow the [Review Record](/{version}/user-guides/apw/essentials/review-record) tutorial to create the change request.
