...
- You need content that will be scheduled. If you don’t have any content, please follow [this tutorial](/{version}/user-guides/apw/essentials/provide-sign-off) to have Black T-Shirt Styling: 5 Timeless Looks for Men blog.

- You need to have the **John Author** user account in your Webiny instance. If you don't have it, please follow the [Create Users](/{version}/user-guides/apw/essentials/apw-user-guides-outline-users-creation) tutorial to create it.
...
6. In the **Date** field, select/type the _publishing date_ (e.g. 01-01-2024).

7. In the **Time** field, select/type the _publishing time_ (e.g. 19:00).
