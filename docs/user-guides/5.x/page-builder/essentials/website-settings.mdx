...
1. Under the **Default Pages** section, in the **Homepage** dropdown, select the page _you want as the homepage_ (e.g. **The benefits of a Serverless CMS** - the page we created in the [Create Page](/{version}/user-guides/page-builder/essentials/create-page) tutorial).
