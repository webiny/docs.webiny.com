...
To follow this tutorial, you need the **The benefits of a Serverless CMS** page. If you don’t have the **The benefits of a Serverless CMS** page, please follow the [Create Page](/{version}/user-guides/page-builder/essentials/create-page) tutorial to create it.
