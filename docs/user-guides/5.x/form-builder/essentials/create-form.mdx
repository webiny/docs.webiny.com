...
To use a form, you need to embed it into a page. In this step, we we will embed the form into a page using the Page Builder. If you are not familiar with how to create a page, please follow the [Create Page](/{version}/user-guides/page-builder/essentials/create-page) tutorial.
...
6. In the **Email** textbox, type _your email_ (e.g. **johndoe@example.com**).
