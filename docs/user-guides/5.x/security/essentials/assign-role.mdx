...
To follow this tutorial, you need to have the **E-commerce** role and the **John Doe** user in your Webiny instance. If you don't have them, please follow the [Creation of Role](/{version}/user-guides/security/essentials/role-creation) and [Creation of User](/{version}/user-guides/security/essentials/user-creation) tutorials to create it.
