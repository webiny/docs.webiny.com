...
In this guide, we will learn how to create a user, and here are additional guides that explain more about [Roles](/{version}/user-guides/security/essentials/role-creation) and [Teams](/{version}/user-guides/security/essentials/team-creation).
