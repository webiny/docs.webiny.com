...
To follow this tutorial, you need to have the **E-commerce** user role in your Webiny instance. If you don't have it, please follow the [Creation of Role](/{version}/user-guides/security/essentials/role-creation) tutorial to create it.
