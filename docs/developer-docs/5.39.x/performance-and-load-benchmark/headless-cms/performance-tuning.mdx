...
export default createCoreApp({
  ...
  pulumi: app => {
    ...
    app.onResource(resource => {
      ...
      const isElasticsearchDomain = isResourceOfType(resource, aws.opensearch.Domain);
