...
You can find more details about the development and deployment principles in this [article](/docs/{version}/core-development-concepts/development/local-development).
