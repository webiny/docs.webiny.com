...
<Section>
  ...
  />
  <SectionRow>
    <SectionBox title="Headless CMS" Icon={HeadlessCmsIcon} learnMoreLink="/docs/{version}/headless-cms/overview">
      <p>
  ...
  <SectionRow>
    ...
    <SectionBox title="Admin Area" Icon={AdminIcon} learnMoreLink="/docs/{version}/admin-area/basics/framework">
      <p>
...
<Section>
  ...
  <SectionRow>
    ...
    <SectionBox title="Core development concepts" Icon={ConceptsIcon} learnMoreLink="/docs/{version}/core-development-concepts/basics/tools-and-libraries">
      <p>
    ...
    <SectionBox title="Customize and extend" Icon={CustomizeIcon} learnMoreLink="/docs/{version}/core-development-concepts/extending-and-customizing/extend-graphql-api">
      <p>
  ...
  <SectionRow>
    <SectionBox title="CI/CD setup" Icon={CiCdIcon} learnMoreLink="/docs/{version}/core-development-concepts/ci-cd/introduction">
      <p>
        If you need to configure and deploy Webiny from a CI/CD environment, follow this guide.
      </p>
    </SectionBox>
    <SectionBox title="Security Framework" Icon={SecurityFrameworkIcon} learnMoreLink="/docs/{version}/core-development-concepts/security-framework/introduction">
      <p>
    ...
    <SectionBox title="Background tasks" Icon={BgTasksIcon} learnMoreLink="/docs/{version}/core-development-concepts/background-tasks/about-background-tasks">
      <p>
