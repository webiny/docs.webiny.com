...
<Section>
  ...
  <SectionRow>
    ...
    <SectionBox title="Admin Area" Icon={ApwIcon} learnMoreLink="/docs/admin-area/basics/framework">
      <p>
        Learn how to customize, white-label and build new apps inside the Webiny Admin area.
      </p>
      <p>
        Learn how to create plugins and customize the Headless CMS experience to your content needs.
      </p>
