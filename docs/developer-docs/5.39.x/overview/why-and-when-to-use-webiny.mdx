...
Webiny is not your typical CMS. We prefer to describe Webiny as a content platform. What's the difference? A platform is a foundation that's designed to be built upon and integrated with other systems. Webiny's foundation provides all the capabilities you might need to manage your content, but its underlying development framework enables you to fully customize the content creation and management experience. 
