...
- Can be customized via [`ProductionEnvironments`](/{version}/reference/extensions#production-environments) extension
...
You can customize which environments use production mode via the [`ProductionEnvironments`](/{version}/reference/extensions#production-environments) extension in your `webiny.config.tsx`.
