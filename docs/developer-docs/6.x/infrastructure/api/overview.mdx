...
For brevity, the diagram doesn't include network-level resources like VPC and availability zones. See [Deployment Modes](/{version}/infrastructure/deployment-modes/introduction) for those details.

</Alert>

<Alert type="info">

Stateful resources like S3, Cognito, DynamoDB, and OpenSearch are shown for clarity but are deployed as part of [Core Infrastructure](/{version}/infrastructure/core/overview).
