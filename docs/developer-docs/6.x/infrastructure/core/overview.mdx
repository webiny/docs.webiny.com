...
Learn more about DynamoDB-only vs DynamoDB + OpenSearch setups in the [Infrastructure Overview](/{version}/infrastructure/introduction#database-setup-options).
