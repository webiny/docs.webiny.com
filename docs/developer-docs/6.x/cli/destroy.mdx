...
The `destroy` command removes all cloud infrastructure resources previously deployed by [`webiny deploy`](/cli/deploy) for a given app and environment. It delegates to Pulumi internally.
