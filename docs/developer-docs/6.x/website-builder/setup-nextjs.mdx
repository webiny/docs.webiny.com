...
If you already have a Next.js app, or you built one on an earlier version of the starter kit, see [Next.js SDK Setup Scenarios](/{version}/website-builder/nextjs-sdk-scenarios) instead.
...
Projects that were first deployed before 6.5 have a key called "Website Builder" instead, and the dialog shows the older `NEXT_PUBLIC_WEBSITE_BUILDER_*` variable names. See [Next.js SDK Setup Scenarios](/{version}/website-builder/nextjs-sdk-scenarios#api-key-and-environment-variables) for how to handle that.
