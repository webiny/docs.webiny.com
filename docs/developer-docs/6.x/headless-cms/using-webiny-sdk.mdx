...
This guide covers practical examples of working with Headless CMS content using the [Webiny SDK](/{version}/core-concepts/webiny-sdk). The SDK provides type-safe methods for querying and mutating content, with automatic API selection and built-in error handling.

<Alert type="info">

For an explanation of the Read and Manage APIs, see [GraphQL API Overview](/{version}/headless-cms/graphql-api-overview).
