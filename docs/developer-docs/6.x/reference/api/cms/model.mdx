...
<SymbolList
  symbols={[
    ...
    { name: "DataFieldBuilder", anchor: "data-field-builder" },
    { name: "FieldRendererRegistry", anchor: "field-renderer-registry" },
    { name: "LayoutBuilder", anchor: "layout-builder" },
    { name: "LayoutFieldBuilder", anchor: "layout-field-builder" },
...
```typescript
import { DataFieldBuilder } from "webiny/api/cms/model";
```
...
```typescript
import { LayoutFieldBuilder } from "webiny/api/cms/model";
```
