...
<SymbolList
  symbols={[
    { name: "LocalStorage", anchor: "localstorage" },
    { name: "useLocalStorage", anchor: "uselocalstorage" },
    { name: "useLocalStorageValue", anchor: "uselocalstoragevalue" },
    { name: "useLocalStorageValues", anchor: "uselocalstoragevalues" }
  ]}
/>
