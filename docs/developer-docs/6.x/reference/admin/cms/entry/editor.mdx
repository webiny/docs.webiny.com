...
<SymbolList
  symbols={[{ name: "ContentEntryEditorConfig", anchor: "content-entry-editor-config" }]}
/>
...
<SymbolList
  symbols={[
    { name: "useContentEntryEditor", anchor: "use-content-entry-editor" },
    { name: "useContentEntryForm", anchor: "use-content-entry-form" },
    { name: "useSingleEntryContentEntry", anchor: "use-single-entry-content-entry" }
  ]}
/>
