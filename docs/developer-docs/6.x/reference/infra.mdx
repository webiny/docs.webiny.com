...
description: "Reference for webiny/infra"
---
...
- What is exported from `webiny/infra`?
...
This page documents everything exported from `webiny/infra`. Import any of the items below directly from this path in your Webiny extensions.
...
**Abstraction** — imported from `webiny/infra`

```typescript
import { AdminStackOutput } from "webiny/infra";
```
...
```typescript
import { AfterBuildHook } from "webiny/infra";
```
...
```typescript
import { AfterDeployHook } from "webiny/infra";
```
...
```typescript
import { ApiStackOutput } from "webiny/infra";
```
...
```typescript
import { BeforeBuildHook } from "webiny/infra";
```
...
```typescript
import { BeforeDeployHook } from "webiny/infra";
```
...
```typescript
import { BeforeWatchHook } from "webiny/infra";
```
...
```typescript
import { CoreStackOutput } from "webiny/infra";
```
...
**Constant** — imported from `webiny/infra`
...
```typescript
import { Logger } from "webiny/infra";
```
