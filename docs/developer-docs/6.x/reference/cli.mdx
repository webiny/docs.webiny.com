...
id: y2xp0000
title: CLI
description: "Reference for webiny/cli"
---
...
- What is exported from `webiny/cli`?
...
This page documents everything exported from `webiny/cli`. Import any of the items below directly from this path in your Webiny extensions.
...
**Abstraction** — imported from `webiny/cli`

```typescript
import { Logger } from "webiny/cli";
```
