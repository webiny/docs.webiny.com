...
```bash
npx webiny-mcp configure
```

This will list all supported agents. Pick yours and run:

```bash
npx webiny-mcp configure {your-agent-name}
```
...
Continue to [First Customization](/docs/{version}/get-started/first-customization).
