...
1. [Quickstart](/docs/{version}/get-started/quickstart) — create a project and deploy it to AWS
2. [Connect Your AI Environment](/docs/{version}/get-started/connect-ai-environment) — set up the MCP server so AI can assist with customizations
3. [First Customization](/docs/{version}/get-started/first-customization) — build a content model as your first code extension
4. [Local Development](/docs/{version}/get-started/local-development) — learn the day-to-day development workflow
5. [Deploy Webiny](/docs/{version}/get-started/deploy-webiny) — understand environments and deployment in depth
