...
Standalone runs on your machine. There is no supported way to deploy it to a server yet, and content cannot be moved between Standalone and AWS. Treat anything you create here as disposable.
