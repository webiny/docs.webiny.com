...
- **Yarn**: Webiny works with both [Yarn 1 (Classic)](https://yarnpkg.com/en/docs/install) (version 1.22.21 or later) and [Yarn ≥3 (Berry)](https://yarnpkg.com/)
- **AWS account and credentials**: you need a valid AWS account with programmatic access configured on your system. If you don't have this set up yet, follow the [Configure AWS Credentials](/5.x/infrastructure/aws/configure-aws-credentials) guide
...
The first deployment typically takes **5 to 15 minutes** as AWS provisions all the necessary resources. It may look like nothing is happening in the terminal, which is normal. Let it finish. If something goes wrong, an error message will appear.
...
After completing the wizard, you will land on the Webiny dashboard. Your instance is now fully operational, with Headless CMS, File Manager, and all other Webiny apps ready to use.
