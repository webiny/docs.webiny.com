...
- **AWS account and credentials** — you need a valid AWS account with programmatic access configured on your system. If you don't have this set up yet, follow the [Configure AWS Credentials](/docs/5.x/infrastructure/aws/configure-aws-credentials) guide
...
Continue to [Connect Your AI Environment](/docs/{version}/get-started/connect-ai-environment).
