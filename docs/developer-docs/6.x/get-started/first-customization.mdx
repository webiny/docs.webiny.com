  ...
  async execute(builder: ModelFactory.Builder) {
    return [
      builder
        ...
        .fields(fields => ({
          title: fields.text().renderer("textInput").label("Title").required("Title is required"),
          slug: fields
            .text()
            .renderer("textInput")
            .label("Slug")
            ...
            .unique(),
          body: fields.richText().renderer("lexicalTextInput").label("Body"),
          category: fields
            .text()
        ...
        .layout([["title", "slug"], ["body"], ["category", "featuredImage"]])
        .titleFieldId("title")
...
Continue to [Local Development](/{version}/get-started/local-development).
