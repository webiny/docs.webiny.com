...
import { CmsContentFormRenderPlugin } from "@webiny/app-headless-cms";

export const Extension = () => {
    return (
        <>
            <CmsContentFormRenderPlugin
                modelId={"pizza"}
                render={({ fields }) => {
...
const renderPizzaLayout: CmsContentFormRenderPluginProps["render"] = ({ fields }) => {
