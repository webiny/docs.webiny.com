...
| `revisionDeletedOn`        | The date/time when an entry revision was last deleted / moved to the trash bin. |
| `revisionRestoredOn`       | The date/time when an entry revision was last restored from the trash bin.      |
...
| `revisionDeletedBy`        | The user who last deleted / moved to the trash bin an entry revision.           |
| `revisionRestoredBy`       | The user who last restored an entry revision from the trash bin.                |
...
| `lastPublishedOn`  | The date/time when an entry was last published.                        |
| `deletedOn`        | The date/time when an entry was last deleted / moved to the trash bin. |
| `restoredOn`       | The date/time when an entry was last restored from the trash bin.      |
...
| `deletedBy`        | The user who last deleted / moved to the trash bin an entry.           |
| `restoredBy`       | The user who last restored an entry from the trash bin.                |
