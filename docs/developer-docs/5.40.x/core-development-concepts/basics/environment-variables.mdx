...
Both variables are necessary for comprehensive customization: 
...
```
For instance, setting both variables to 0 will result in the default retention period being applied.
