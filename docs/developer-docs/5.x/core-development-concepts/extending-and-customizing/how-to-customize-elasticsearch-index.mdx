...
<Alert type="warning">
  Note that each tenant, locale and CMS model combination creates it's own index. Page Builder, Form
  Builder, and some other apps, always create a single index per tenant and locale combination.
</Alert>
