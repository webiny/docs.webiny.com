...
For more information on packages and their role in a Webiny project, take a step back and check the [Applications and Packages](/{version}/core-development-concepts/project-organization/project-applications-and-packages) topic.
...
An abstract example of packages and shared packages, located in different project applications, can be found in the [Project Applications and Packages](/{version}/core-development-concepts/project-organization/project-applications-and-packages) topic:
