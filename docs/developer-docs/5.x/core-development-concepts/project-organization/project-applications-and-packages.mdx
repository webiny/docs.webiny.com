...
<!--
## Webiny Project
Everything starts with a **Webiny project**, which is what gets created for you (on your local file system) in the [Webiny Installation](/{version}/get-started/install-webiny) process. This is the top organizational unit, which is made of packages and project applications.
-->
...
Visit the [Project Applications](/{version}/core-development-concepts/project-organization/project-applications) section to learn more about project applications.

</Alert>

<Alert type="success">

Every Webiny project is organized as a monorepo. Visit the [Monorepo Organization](/{version}/core-development-concepts/project-organization/monorepo-organization) topic to learn more.
