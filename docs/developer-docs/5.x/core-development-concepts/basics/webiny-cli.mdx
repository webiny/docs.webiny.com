...
Additionally, the Webiny CLI is pluggable, meaning you can easily create your own custom commands, or even replace the existing ones. Please visit the [Adding Custom Commands](/{version}/core-development-concepts/extending-and-customizing/adding-custom-cli-commands) guide for more information.
...
<Alert type="info">
  ...
  For more hands-on information on the above listed commands, please visit the [Deploy Your Project](/{version}/core-development-concepts/basics/project-deployment) and [Destroy Cloud Infrastructure](/{version}/infrastructure/basics/destroy-cloud-infrastructure) guides.
...
<Alert type="info">
  ...
  For more information, please visit the [Execute Pulumi Commands](/{version}/infrastructure/pulumi-iac/execute-pulumi-commands) guide.
...
<Alert type="info">
  ...
  For more information, please visit the [Use Watch Command](/{version}/core-development-concepts/basics/watch-command) guide.
...
Makes it easy to start developing new Webiny extensions. To learn more about extensions, please visit the [Extensions](/{version}/core-development-concepts/basics/extensions) article.
