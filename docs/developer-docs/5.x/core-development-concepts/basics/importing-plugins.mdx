...
If you're not yet familiar with the concept of plugins in Webiny, please refer to the [Plugins](/{version}/core-development-concepts/basics/plugins) key topic article.
...
- [React applications (Admin Area and Website)](/{version}/core-development-concepts/basics/importing-plugins#react-applications)
- [GraphQL API](/{version}/core-development-concepts/basics/importing-plugins#graphql-api)
- [Webiny CLI](/{version}/core-development-concepts/basics/importing-plugins#webiny-cli)
...
To register a new plugin, you need to navigate to the appropriate plugins entry file, and add your plugin to the end of the array that is being registered into the [PluginsContainer](/{version}/core-development-concepts/basics/plugins#plugins-container).
...
- Main GraphQL API: [`apps/api/code/graphql/src/index.ts`](https://github.com/webiny/webiny-js/blob/next/apps/api/code/graphql/src/index.ts)
...
```ts api/code/graphql/src/plugins/myPlugins.ts
// A dedicated file for your custom plugin(s)
export default [
  {
    type: "my-plugin-type",
...
If you already have the [watch](/{version}/core-development-concepts/basics/watch-command#webiny-watch-command) running, the new import will be picked up, built, and deployed to the cloud automatically.

If not, you'll need to [deploy](/{version}/core-development-concepts/basics/project-deployment#the-deploy-command) your API manually, to apply the new plugin(s).
...
To learn more, please read the [Plugins](/{version}/core-development-concepts/basics/plugins) key topic article.
