...
<Alert type="info">
  ...
  Extensions are the primary way to develop on top Webiny and extend it. To learn more, check out the [Extensions](/{version}/core-development-concepts/basics/extensions) article.
