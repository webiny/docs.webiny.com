...
For any larger projects, we recommend you scale up your ElasticSearch cluster to something with more capacity. You can look at our [Headless CMS benchmark](/{version}/performance-and-load-benchmark/headless-cms/write-benchmark) where we compare several different cluster configurations to get a sense of what might best suit your needs.
