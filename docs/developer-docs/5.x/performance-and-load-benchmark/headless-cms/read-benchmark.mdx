...
This test is following the same plan and load structure as the [Headless CMS write operation benchmark](/{version}/performance-and-load-benchmark/headless-cms/write-benchmark#test-plan).
