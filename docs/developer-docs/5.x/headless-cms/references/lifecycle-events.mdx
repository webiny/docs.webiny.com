...
<Alert type="danger" title="Deprecation of lifecycle events created before 5.x">
...
This event is triggered before all entry revisions are deleted from the database or moved to trash bin.

#### Event arguments

| Property  | Description                                                              |
|-----------|--------------------------------------------------------------------------|
| entry     | Entry object which is going to be deleted or moved to trash bin          |
| model     | Model this entry belongs to                                              |
| permanent | Has the entry been permanently deleted or merely moved to the trash bin? |
...
This event is triggered after all entry revisions are deleted from the database or moved to trash bin.
...
| Property  | Description                                                              |
|-----------|--------------------------------------------------------------------------|
| entry     | Entry object which was going to be deleted or moved to trash bin         |
| model     | Model this entry belongs to                                              |
| permanent | Has the entry been permanently deleted or merely moved to the trash bin? |
| error     | thrown error                                                             |
...
This event is triggered before all entry revisions are restored from the trash bin.

#### Event arguments

| Property  | Description                                                              |
|-----------|--------------------------------------------------------------------------|
| entry     | Entry object which is going to be restored                               |
| model     | Model this entry belongs to                                              |
...
This event is triggered after all entry revisions are restored from the trash bin.
...
This event is triggered on entry restore error.

#### Event arguments

| Property  | Description                                 |
|-----------|---------------------------------------------|
| entry     | Entry object which was going to be restored |
| model     | Model this entry belongs to                 |
| error     | thrown error                                |
