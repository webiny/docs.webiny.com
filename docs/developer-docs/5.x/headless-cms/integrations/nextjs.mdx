...
1. [Set up your AWS credentials locally](/{version}/infrastructure/aws/configure-aws-credentials)
2. [Deployed a Webiny instance to a dev environment](/{version}/core-development-concepts/basics/project-deployment)
...
For more information about the [Headless CMS GraphQL API, see this page of our docs](/{version}/headless-cms/basics/graphql-api).
...
There's [more information about using GraphQL here](/{version}/headless-cms/basics/using-graphql-api).
...
[For more information about the rich text renderer package, see this documentation](/{version}/headless-cms/integrations/legacy-render-rich-text-content).
