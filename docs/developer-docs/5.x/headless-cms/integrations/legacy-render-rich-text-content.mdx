...
<Alert type="warning">
  ...
  deprecated with the release of <Link href={"../../release-notes/5.x/changelog"}>v5.x</Link>. For
  instructions on rendering of the new rich text content, please visit the&nbsp;
...
To learn how to use Headless CMS GraphQL API, make sure to check out the [Using GraphQL API](/{version}/headless-cms/basics/using-graphql-api) key topic.
