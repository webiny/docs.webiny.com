...
You can write any filtering logic based on [Headless CMS's built-in GraphQL API filtering](/{version}/headless-cms/basics/using-graphql-api-advanced-filtering).
