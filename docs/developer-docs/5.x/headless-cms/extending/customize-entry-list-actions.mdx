...
```tsx
<ContentEntryListConfig>
  <Browser.FolderAction name={"copy-json"} element={<CopyFolderData />} modelIds={["property"]} />
</ContentEntryListConfig>
```
...
```tsx
<ContentEntryListConfig>
  <Browser.FolderAction name={"copy-json"} element={<CopyFolderData />} before={"delete"} />
</ContentEntryListConfig>
```
...
```tsx
<ContentEntryListConfig>
  <Browser.FolderAction name={"delete"} element={<span>A new action!</span>} />
</ContentEntryListConfig>
```
...
```tsx
<ContentEntryListConfig>
  <Browser.EntryAction name={"copy-json"} element={<CopyEntryData />} modelIds={["property"]} />
</ContentEntryListConfig>
```
...
```tsx
<ContentEntryListConfig>
  <Browser.EntryAction name={"copy-json"} element={<CopyEntryData />} before={"delete"} />
</ContentEntryListConfig>
```
...
```tsx
<ContentEntryListConfig>
  <Browser.EntryAction name={"delete"} element={<span>A new action!</span>} />
</ContentEntryListConfig>
```
