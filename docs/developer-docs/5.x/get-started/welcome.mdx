...
<Section>
  ...
  <SectionRow>
    <SectionBox
      ...
      learnMoreLink="/docs/{version}/headless-cms/overview"
    >
      <p>
    ...
    <SectionBox
      ...
      learnMoreLink="/docs/page-builder/overview"
    >
      <p>
  ...
  <SectionRow>
    <SectionBox
      ...
      learnMoreLink="/docs/file-manager/extending/customize-file-filters"
    >
      <p>
    ...
    <SectionBox
      ...
      learnMoreLink="/docs/form-builder/theming/introduction"
    >
      <p>
    ...
    <SectionBox
      title="Admin Area"
      Icon={AdminIcon}
      learnMoreLink="/docs/{version}/admin-area/basics/framework"
    >
      <p>
...
<Section>
  ...
  <SectionRow>
    <SectionBox
      ...
      Icon={VideoIcon}
      learnMoreLink="https://www.youtube.com/playlist?list=PL9HlKSQaEuXTGvfbFiBg0u_gOhphvof2r"
    >
      <p>
    ...
    <SectionBox title="Core development concepts" Icon={ConceptsIcon}>
      <p>
    ...
    <SectionBox
      ...
      Icon={CustomizeIcon}
      learnMoreLink="/docs/{version}/core-development-concepts/extending-and-customizing/extend-graphql-api"
    >
      <p>
  ...
  <SectionRow>
    <SectionBox
      title="CI/CD setup"
      Icon={CiCdIcon}
      learnMoreLink="/docs/{version}/core-development-concepts/ci-cd/introduction"
    >
    ...
    <SectionBox
      ...
      learnMoreLink="/docs/{version}/core-development-concepts/security-framework/introduction"
    >
      <p>
    ...
    <SectionBox
      ...
      Icon={BgTasksIcon}
      learnMoreLink="/docs/{version}/core-development-concepts/background-tasks/about-background-tasks"
    >
      <p>
...
<Section>
  ...
  <SectionRow>
    <SectionBox
      title="User guides"
      Icon={UserGuidesIcon}
      learnMoreLink="/docs/user-guides/overview"
    >
    ...
    <SectionBox
      ...
      learnMoreLink="/docs/release-notes/upgrade-webiny"
    >
  ...
  <SectionRow>
    <SectionBox
      ...
      Icon={CompanyHandbookIcon}
      learnMoreLink="/docs/handbook/company/why-webiny-exists"
    >
      <p>
