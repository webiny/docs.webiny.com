...
- in order to deploy Webiny, you must have a valid [AWS account and user credentials](/{version}/infrastructure/aws/configure-aws-credentials) set up on your system
...
Learn what gets deployed into your AWS account and how it all works in the [Cloud Infrastructure](/{version}/architecture/introduction)
key topics section.
...
product and understanding usage patterns. Please take a look at our [Telemetry](/{version}/webiny-telemetry/webiny-telemetry)
page for more information on this subject.

If, at any point in time, you wish to disable this behaviour, you can do it with the [Webiny CLI](/{version}/core-development-concepts/basics/webiny-cli),
