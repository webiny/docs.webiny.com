...
[`apps/theme/layouts/forms/DefaultFormLayout.tsx`](https://github.com/webiny/webiny-js/blob/next/apps/theme/layouts/forms/DefaultFormLayout.tsx)
...
2. then, register it as a [`form-layout`](/{version}/form-builder/references/plugins#form-layout) plugin
...
let's register a new [`form layout`](/{version}/form-builder/references/plugins#form-layout) plugin:
