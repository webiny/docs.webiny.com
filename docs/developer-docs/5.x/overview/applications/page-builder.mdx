...
Checkout this tutorial on how to create [custom Page Builder elements](/{version}/page-builder/extending/create-a-page-element).
...
Checkout the Page Builder page delivery performance in the [benchmark section](/{version}/performance-and-load-benchmark/introduction).
