...
With these steps completed, the page is ready to be served to actual website visitors. Continue reading the [Serving Pages](/{version}/architecture/website/serving-pages) section to learn more.
