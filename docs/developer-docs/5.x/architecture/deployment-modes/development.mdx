...
For more information, visit the [Different Setups](/{version}/get-started/install-webiny#pick-your-database) sections.

</Alert>

Development mode is a reasonable choice when it comes to development environments. But, for production, since some of the cloud infrastructure resources may require that they are not exposed to the public internet, the [production](/{version}/architecture/deployment-modes/production) may be a better solution.
