...
In the upcoming [Serving Application Files](/{version}/architecture/admin/serving-application-files) section, we examine how the Admin Area application is served to actual users.
