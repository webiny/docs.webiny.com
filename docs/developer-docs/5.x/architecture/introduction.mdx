...
A Webiny project consists of four [project applications](/{version}/core-development-concepts/project-organization/project-applications):
...
Visit the [Deployments](/{version}/infrastructure/basics/introduction) key topics section to learn more about how Webiny approaches cloud infrastructure deployment.
...
If needed, Webiny can also be deployed into a preexisting [Virtual Private Cloud (VPC)](https://aws.amazon.com/vpc/). For more information, please refer to the [Use Existing Amazon VPC](/{version}/enterprise/use-existing-amazon-vpc) guide.
