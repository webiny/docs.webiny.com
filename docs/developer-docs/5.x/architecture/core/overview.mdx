...
Learn more about the different database setups in the [introduction](/{version}/architecture/introduction#different-database-setups) section.
...
The service is utilized from the **Default GraphQL API** and **Headless CMS GraphQL API** AWS Lambda functions, both part of the [API project application](/{version}/architecture/api/overview).
