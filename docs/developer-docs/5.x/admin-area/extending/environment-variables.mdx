...
Note that the naming convention for environment variables is explained in a dedicated article on [Environment Variables](/{version}/core-development-concepts/basics/environment-variables).
