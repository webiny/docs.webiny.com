...
<WhatYouWillLearn>
  - what are environment-related utility functions - what environment-related utility functions are
  available
</WhatYouWillLearn>
...
To learn more about extensions in general, please visit the [Extensions](/{version}/core-development-concepts/basics/extensions) article.
