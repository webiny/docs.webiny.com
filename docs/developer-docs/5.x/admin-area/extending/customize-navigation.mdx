...
the examples to your `apps/admin/src/App.tsx`. We highly recommend using our [Extensions](/{version}/core-development-concepts/basics/extensions) to organize your code in a scalable and portable manner.
