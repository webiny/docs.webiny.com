...
Internally, the [`webiny deploy`](/{version}/core-development-concepts/basics/project-deployment) command consists of two steps:
...
This is why the [`webiny deploy`](/{version}/core-development-concepts/basics/project-deployment) command enables hooking onto a couple of its key lifecycle events:
...
Except for the [`webiny deploy`](/{version}/core-development-concepts/basics/project-deployment) command, hooking onto key lifecycle events is also supported by the [`webiny watch`](/{version}/core-development-concepts/basics/watch-command) command.
