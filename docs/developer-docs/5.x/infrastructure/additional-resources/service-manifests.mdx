...
Out of the box, Webiny writes service manifests when deploying the `api` and `website` apps. You can find the definitions of these manifests in the [api](https://github.com/webiny/webiny-js/blob/v5.x/packages/pulumi-aws/src/apps/api/createApiPulumiApp.ts#L321-L329) and [website](https://github.com/webiny/webiny-js/blob/v5.x/packages/pulumi-aws/src/apps/website/createWebsitePulumiApp.ts#L335-L363) pulumi apps.
