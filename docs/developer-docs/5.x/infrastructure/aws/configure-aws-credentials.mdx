...
This is the only time that the secret access key can be viewed or downloaded. You cannot recover it later. However, you can create a new access key any time. Copy this _Access key_ and **Secret access key**.
...
If you don't have one, please refer to the [previous step](/{version}/infrastructure/aws/configure-aws-credentials#step-2-create-a-user-for-programmatic-access).
...
If you would like to use a different name for your AWS profile, you can do that too. Check out the [Use AWS Profiles](/{version}/infrastructure/aws/use-aws-profiles) how-to guide for more information.
