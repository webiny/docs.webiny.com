...
```tsx
<FileManagerViewConfig>
  <Browser.FolderAction name={"copy-json"} element={<CopyFolderData />} />
</FileManagerViewConfig>
```
...
```tsx
<FileManagerViewConfig>
  <Browser.FileAction name={"copy-json"} element={<CopyFileData />} />
</FileManagerViewConfig>
```
...
```tsx
<FileManagerViewConfig>
  <Browser.FileAction name={"copy-json"} element={<CopyFileData />} before={"delete"} />
</FileManagerViewConfig>
```
...
```tsx
<FileManagerViewConfig>
  <Browser.FileAction name={"delete"} element={<span>A new action!</span>} />
</FileManagerViewConfig>
```
