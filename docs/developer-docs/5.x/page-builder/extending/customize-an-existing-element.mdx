...
There's only one plugin you need to modify to customize an element: [`PbEditorPageElementPlugin`](/{version}/page-builder/references/plugins#pb-editor-page-element).
...
Both are of type: [`PbEditorPageElementStyleSettingsPlugin`](/{version}/page-builder/references/plugins#pb-editor-page-element-style-settings).
