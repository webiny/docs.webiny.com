...
For detailed documentation on each extension point, see the specific sections on [Builders](/docs/{version}/headless-cms/builder), [Event Handlers](/docs/{version}/headless-cms/event-handler), and [Use Cases](/docs/{version}/headless-cms/use-case).
