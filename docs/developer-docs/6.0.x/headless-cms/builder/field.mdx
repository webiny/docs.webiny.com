...
**`renderer(name: string, settings?: Record<string, any>)`** - Sets the field renderer. See [Field Renderers](/docs/developer-docs/6.0.x/headless-cms/ui/field-renderer) for available renderers.
...
For a complete list of available renderers and which fields they support, see the [Field Renderers](/docs/developer-docs/6.0.x/headless-cms/ui/field-renderer) documentation.
