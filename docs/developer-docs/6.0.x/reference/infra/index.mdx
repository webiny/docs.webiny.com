...
<SymbolList
  symbols={[
    { name: "AfterBuildHook", anchor: "afterbuildhook" },
    { name: "AfterDeployHook", anchor: "afterdeployhook" },
    { name: "BeforeBuildHook", anchor: "beforebuildhook" },
    { name: "BeforeDeployHook", anchor: "beforedeployhook" },
    { name: "BeforeWatchHook", anchor: "beforewatchhook" },
    { name: "GetAppStackOutput", anchor: "getappstackoutput" },
