...
- [`ApiAfterBuildHook`](#apiafterbuildhook)
- [`ApiAfterDeployHook`](#apiafterdeployhook)
- [`ApiBeforeBuildHook`](#apibeforebuildhook)
- [`ApiBeforeDeployHook`](#apibeforedeployhook)
- [`ApiBeforeWatchHook`](#apibeforewatchhook)
- [`ApiPulumi`](#apipulumi)
- [`GetApiStackOutput`](#getapistackoutput)
