...
- [`CoreAfterBuildHook`](#coreafterbuildhook)
- [`CoreAfterDeployHook`](#coreafterdeployhook)
- [`CoreBeforeBuildHook`](#corebeforebuildhook)
- [`CoreBeforeDeployHook`](#corebeforedeployhook)
- [`CorePulumi`](#corepulumi)
- [`GetCoreStackOutput`](#getcorestackoutput)
