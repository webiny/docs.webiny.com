...
<SymbolList
  symbols={[
    { name: "CoreAfterBuildHook", anchor: "coreafterbuildhook" },
    { name: "CoreAfterDeployHook", anchor: "coreafterdeployhook" },
    { name: "CoreBeforeBuildHook", anchor: "corebeforebuildhook" },
    { name: "CoreBeforeDeployHook", anchor: "corebeforedeployhook" },
    { name: "CorePulumi", anchor: "corepulumi" },
    { name: "GetCoreStackOutput", anchor: "getcorestackoutput" }
  ]}
/>
