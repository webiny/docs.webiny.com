...
- [`AdminAfterBuildHook`](#adminafterbuildhook)
- [`AdminAfterDeployHook`](#adminafterdeployhook)
- [`AdminBeforeBuildHook`](#adminbeforebuildhook)
- [`AdminBeforeDeployHook`](#adminbeforedeployhook)
- [`AdminBeforeWatchHook`](#adminbeforewatchhook)
- [`AdminPulumi`](#adminpulumi)
- [`GetAdminStackOutput`](#getadminstackoutput)
