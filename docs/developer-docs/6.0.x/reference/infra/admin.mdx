...
<SymbolList
  symbols={[
    { name: "AdminAfterBuildHook", anchor: "adminafterbuildhook" },
    { name: "AdminAfterDeployHook", anchor: "adminafterdeployhook" },
    { name: "AdminBeforeBuildHook", anchor: "adminbeforebuildhook" },
    { name: "AdminBeforeDeployHook", anchor: "adminbeforedeployhook" },
    { name: "AdminBeforeWatchHook", anchor: "adminbeforewatchhook" },
    { name: "AdminPulumi", anchor: "adminpulumi" },
    { name: "GetAdminStackOutput", anchor: "getadminstackoutput" }
  ]}
/>
