...
<SymbolList symbols={[{ name: "LexicalNode", anchor: "lexical-node" }]} />
...
<SymbolList symbols={[{ name: "Klass", anchor: "klass" }]} />

### Other

<SymbolList symbols={[{ name: "getNodeFromSelection", anchor: "get-node-from-selection" }]} />
