...
<SymbolList
  symbols={[
    ...
    { name: "FormApi", anchor: "formapi" },
    { name: "FormOnSubmit", anchor: "formonsubmit" },
    { name: "GenericFormData", anchor: "genericformdata" },
    { name: "UnsetOnUnmount", anchor: "unsetonunmount" },
    { name: "useBind", anchor: "usebind" },
    { name: "useBindPrefix", anchor: "usebindprefix" },
    { name: "useForm", anchor: "useform" },
    { name: "useGenerateSlug", anchor: "usegenerateslug" },
    { name: "validation", anchor: "validation" },
    { name: "Validation", anchor: "validation" },
    { name: "ValidationError", anchor: "validationerror" }
  ]}
/>
