...
<SymbolList symbols={[{ name: "ContentEntryListConfig", anchor: "content-entry-list-config" }]} />
...
<SymbolList symbols={[{ name: "useContentEntriesList", anchor: "use-content-entries-list" }]} />
