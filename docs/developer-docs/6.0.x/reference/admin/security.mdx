...
<SymbolList
  symbols={[
    { name: "AuthenticationContext", anchor: "authenticationcontext" },
    { name: "AuthenticationErrorEventHandler", anchor: "authenticationerroreventhandler" },
    { name: "IdentityContext", anchor: "identitycontext" },
    { name: "LogInUseCase", anchor: "loginusecase" },
    { name: "LogOutUseCase", anchor: "logoutusecase" },
    { name: "useAuthentication", anchor: "useauthentication" },
    { name: "useIdentity", anchor: "useidentity" }
  ]}
/>
...
class MyImpl implements LogInUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(params: ILoginParams): Promise<void> {
    // implementation
  }
}

export default LogInUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements LogOutUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default LogOutUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
