...
<SymbolList
  symbols={[
    ...
    { name: "CreateModelFromUseCase", anchor: "createmodelfromusecase" },
    { name: "CreateModelUseCase", anchor: "createmodelusecase" },
    { name: "DeleteModelUseCase", anchor: "deletemodelusecase" },
    { name: "FieldBuilder", anchor: "fieldbuilder" },
    { name: "FieldRendererRegistry", anchor: "fieldrendererregistry" },
    { name: "FieldType", anchor: "fieldtype" },
    { name: "GetModelUseCase", anchor: "getmodelusecase" },
    { name: "LayoutBuilder", anchor: "layoutbuilder" },
    { name: "ListModelsUseCase", anchor: "listmodelsusecase" },
    { name: "ModelAfterCreateEventHandler", anchor: "modelaftercreateeventhandler" },
    { name: "ModelAfterCreateFromEventHandler", anchor: "modelaftercreatefromeventhandler" },
    { name: "ModelAfterDeleteEventHandler", anchor: "modelafterdeleteeventhandler" },
    { name: "ModelAfterUpdateEventHandler", anchor: "modelafterupdateeventhandler" },
    { name: "ModelBeforeCreateEventHandler", anchor: "modelbeforecreateeventhandler" },
    { name: "ModelBeforeCreateFromEventHandler", anchor: "modelbeforecreatefromeventhandler" },
    { name: "ModelBeforeDeleteEventHandler", anchor: "modelbeforedeleteeventhandler" },
    { name: "ModelBeforeUpdateEventHandler", anchor: "modelbeforeupdateeventhandler" },
    { name: "ModelBuilder", anchor: "modelbuilder" },
    { name: "ModelFactory", anchor: "modelfactory" },
    { name: "UpdateModelUseCase", anchor: "updatemodelusecase" }
  ]}
/>
...
class MyImpl implements CreateModelFromUseCase.Interface {
...
export default CreateModelFromUseCase.createImplementation({
...
class MyImpl implements CreateModelUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(input: CmsModelCreateInput): Promise<Result<CmsModel, UseCaseError>> {
    // implementation
  }
}

export default CreateModelUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements DeleteModelUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(modelId: string): Promise<Result<void, UseCaseError>> {
    // implementation
  }
}

export default DeleteModelUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements GetModelUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(modelId: string): Promise<Result<CmsModel, UseCaseError>> {
    // implementation
  }
}

export default GetModelUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements ListModelsUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(params?: ICmsModelListParams): Promise<Result<CmsModel[], UseCaseError>> {
    // implementation
  }
}

export default ListModelsUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements UpdateModelUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default UpdateModelUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
