...
<SymbolList
  symbols={[
    { name: "AppInstaller", anchor: "appinstaller" },
    { name: "CreateTenantRepository", anchor: "createtenantrepository" },
    { name: "CreateTenantUseCase", anchor: "createtenantusecase" },
    { name: "DeleteTenantRepository", anchor: "deletetenantrepository" },
    { name: "DeleteTenantUseCase", anchor: "deletetenantusecase" },
    { name: "GetTenantByIdUseCase", anchor: "gettenantbyidusecase" },
    { name: "InstallTenantUseCase", anchor: "installtenantusecase" },
    { name: "TenantAfterCreateHandler", anchor: "tenantaftercreatehandler" },
    { name: "TenantAfterDeleteHandler", anchor: "tenantafterdeletehandler" },
    { name: "TenantAfterUpdateHandler", anchor: "tenantafterupdatehandler" },
    { name: "TenantBeforeCreateHandler", anchor: "tenantbeforecreatehandler" },
    { name: "TenantBeforeDeleteHandler", anchor: "tenantbeforedeletehandler" },
    { name: "TenantBeforeUpdateHandler", anchor: "tenantbeforeupdatehandler" },
    { name: "TenantContext", anchor: "tenantcontext" },
    { name: "TenantInstalledHandler", anchor: "tenantinstalledhandler" },
    { name: "UpdateTenantRepository", anchor: "updatetenantrepository" },
    { name: "UpdateTenantUseCase", anchor: "updatetenantusecase" }
  ]}
/>
...
class MyImpl implements CreateTenantRepository.Interface {
...
export default CreateTenantRepository.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements CreateTenantUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default CreateTenantUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements DeleteTenantRepository.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default DeleteTenantRepository.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements DeleteTenantUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default DeleteTenantUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements GetTenantByIdUseCase.Interface {
  public constructor(/* inject dependencies here */) {}

  public async execute(id: string): Promise<Result<Tenant, GetTenantByIdError>> {
    // implementation
  }
}

export default GetTenantByIdUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements InstallTenantUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default InstallTenantUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements UpdateTenantRepository.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default UpdateTenantRepository.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
...
class MyImpl implements UpdateTenantUseCase.Interface {
  public constructor(/* inject dependencies here */) {}
...
export default UpdateTenantUseCase.createImplementation({
  implementation: MyImpl,
  dependencies: []
});
```
