...
- [`DeleteTenantRepository`](#deletetenantrepository)
- [`DeleteTenantUseCase`](#deletetenantusecase)
- [`GetTenantByIdUseCase`](#gettenantbyidusecase)
- [`InstallTenantUseCase`](#installtenantusecase)
- [`TenantAfterCreateHandler`](#tenantaftercreatehandler)
- [`TenantAfterDeleteHandler`](#tenantafterdeletehandler)
- [`TenantAfterUpdateHandler`](#tenantafterupdatehandler)
- [`TenantBeforeCreateHandler`](#tenantbeforecreatehandler)
- [`TenantBeforeDeleteHandler`](#tenantbeforedeletehandler)
- [`TenantBeforeUpdateHandler`](#tenantbeforeupdatehandler)
- [`TenantContext`](#tenantcontext)
- [`TenantInstalledHandler`](#tenantinstalledhandler)
- [`UpdateTenantRepository`](#updatetenantrepository)
