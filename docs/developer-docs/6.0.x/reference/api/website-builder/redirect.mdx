...
<SymbolList
  symbols={[
    { name: "CreateRedirectUseCase", anchor: "createredirectusecase" },
    { name: "DeleteRedirectUseCase", anchor: "deleteredirectusecase" },
    { name: "GetActiveRedirectsUseCase", anchor: "getactiveredirectsusecase" },
    { name: "GetRedirectByIdUseCase", anchor: "getredirectbyidusecase" },
    { name: "InvalidateRedirectsCacheUseCase", anchor: "invalidateredirectscacheusecase" },
    { name: "ListRedirectsUseCase", anchor: "listredirectsusecase" },
    { name: "MoveRedirectUseCase", anchor: "moveredirectusecase" },
    { name: "RedirectAfterCreateHandler", anchor: "redirectaftercreatehandler" },
    { name: "RedirectAfterDeleteHandler", anchor: "redirectafterdeletehandler" },
    { name: "RedirectAfterMoveHandler", anchor: "redirectaftermovehandler" },
    { name: "RedirectAfterUpdateHandler", anchor: "redirectafterupdatehandler" },
    { name: "RedirectBeforeCreateHandler", anchor: "redirectbeforecreatehandler" },
    { name: "RedirectBeforeDeleteHandler", anchor: "redirectbeforedeletehandler" },
    { name: "RedirectBeforeMoveHandler", anchor: "redirectbeforemovehandler" },
    { name: "RedirectBeforeUpdateHandler", anchor: "redirectbeforeupdatehandler" },
    { name: "UpdateRedirectUseCase", anchor: "updateredirectusecase" }
  ]}
/>
