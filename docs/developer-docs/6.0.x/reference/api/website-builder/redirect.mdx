...
<SymbolList
  symbols={[
    { name: "RedirectAfterCreateHandler", anchor: "redirect-after-create-handler" },
    { name: "RedirectAfterDeleteHandler", anchor: "redirect-after-delete-handler" },
    { name: "RedirectAfterMoveHandler", anchor: "redirect-after-move-handler" },
    { name: "RedirectAfterUpdateHandler", anchor: "redirect-after-update-handler" },
    { name: "RedirectBeforeCreateHandler", anchor: "redirect-before-create-handler" },
    { name: "RedirectBeforeDeleteHandler", anchor: "redirect-before-delete-handler" },
    { name: "RedirectBeforeMoveHandler", anchor: "redirect-before-move-handler" },
    { name: "RedirectBeforeUpdateHandler", anchor: "redirect-before-update-handler" }
  ]}
/>
