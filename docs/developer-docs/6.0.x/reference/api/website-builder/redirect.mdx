...
- [`CreateRedirectUseCase`](#createredirectusecase)
- [`DeleteRedirectUseCase`](#deleteredirectusecase)
- [`GetActiveRedirectsUseCase`](#getactiveredirectsusecase)
- [`GetRedirectByIdUseCase`](#getredirectbyidusecase)
- [`InvalidateRedirectsCacheUseCase`](#invalidateredirectscacheusecase)
- [`ListRedirectsUseCase`](#listredirectsusecase)
- [`MoveRedirectUseCase`](#moveredirectusecase)
- [`RedirectAfterCreateHandler`](#redirectaftercreatehandler)
- [`RedirectAfterDeleteHandler`](#redirectafterdeletehandler)
- [`RedirectAfterMoveHandler`](#redirectaftermovehandler)
- [`RedirectAfterUpdateHandler`](#redirectafterupdatehandler)
- [`RedirectBeforeCreateHandler`](#redirectbeforecreatehandler)
- [`RedirectBeforeDeleteHandler`](#redirectbeforedeletehandler)
- [`RedirectBeforeMoveHandler`](#redirectbeforemovehandler)
- [`RedirectBeforeUpdateHandler`](#redirectbeforeupdatehandler)
- [`UpdateRedirectUseCase`](#updateredirectusecase)
