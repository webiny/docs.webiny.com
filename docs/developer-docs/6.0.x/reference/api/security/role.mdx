...
- [`RoleAfterCreateHandler`](#roleaftercreatehandler)
- [`RoleAfterDeleteHandler`](#roleafterdeletehandler)
- [`RoleAfterUpdateHandler`](#roleafterupdatehandler)
- [`RoleBeforeCreateHandler`](#rolebeforecreatehandler)
- [`RoleBeforeDeleteHandler`](#rolebeforedeletehandler)
- [`RoleBeforeUpdateHandler`](#rolebeforeupdatehandler)
