...
<SymbolList
  symbols={[
    ...
    { name: "createHasPermission", anchor: "createhaspermission" },
    { name: "createPermissionSchema", anchor: "createpermissionschema" },
    { name: "createUsePermissions", anchor: "createusepermissions" },
    { name: "NetworkErrorEventHandler", anchor: "networkerroreventhandler" },
    { name: "useFeature", anchor: "usefeature" }
  ]}
/>
