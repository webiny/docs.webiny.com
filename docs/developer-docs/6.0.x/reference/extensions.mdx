...
<SymbolList
  symbols={[
    ...
    { name: "AdminStackOutputService", anchor: "admin-stack-output-service" },
    { name: "Api", anchor: "api" },
    { name: "ApiGqlClient", anchor: "api-gql-client" },
    { name: "ApiStackOutputService", anchor: "api-stack-output-service" },
    { name: "Cli", anchor: "cli" },
    { name: "CoreStackOutputService", anchor: "core-stack-output-service" },
