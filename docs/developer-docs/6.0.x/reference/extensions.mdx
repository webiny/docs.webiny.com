...
<SymbolList
  symbols={[
    ...
    { name: "AdminStackOutputService", anchor: "adminstackoutputservice" },
    { name: "Api", anchor: "api" },
    { name: "ApiGqlClient", anchor: "apigqlclient" },
    { name: "ApiStackOutputService", anchor: "apistackoutputservice" },
    { name: "Cli", anchor: "cli" },
    { name: "CoreStackOutputService", anchor: "corestackoutputservice" },
    { name: "EnvVar", anchor: "envvar" },
    { name: "Infra", anchor: "infra" },
    { name: "InvokeLambdaFunction", anchor: "invokelambdafunction" },
