...
import bannerComponentEditor from "./assets/banner-component-editor.png";
import bannerComponentRendered from "./assets/banner-component-rendered.png";
