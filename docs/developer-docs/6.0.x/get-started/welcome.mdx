...
1. [Quickstart](/docs/developer-docs/6.0.x/get-started/quickstart) — create a project and deploy it to AWS
2. [Connect Your AI Environment](/docs/developer-docs/6.0.x/get-started/connect-ai-environment) — set up the MCP server so AI can assist with customizations
3. [First Customization](/docs/developer-docs/6.0.x/get-started/first-customization) — build a content model as your first code extension
4. [Local Development](/docs/developer-docs/6.0.x/get-started/local-development) — learn the day-to-day development workflow
5. [Deploy Webiny](/docs/developer-docs/6.0.x/get-started/deploy-webiny) — understand environments and deployment in depth
