...
Before using the watch commands, make sure your project is deployed. If you followed the [Quickstart](/docs/developer-docs/6.0.x/get-started/quickstart), you already have a `dev` environment running.
...
Continue to [Deploy Webiny](/docs/developer-docs/6.0.x/get-started/deploy-webiny).
