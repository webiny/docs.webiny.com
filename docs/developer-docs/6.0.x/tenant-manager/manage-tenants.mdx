...
description: Learn how to manage tenants within Webiny via the GraphQL API
---
...
This guide covers the core tenant management operations available through the Webiny GraphQL API.

## Prerequisites

- Access to your Webiny GraphQL API endpoint
