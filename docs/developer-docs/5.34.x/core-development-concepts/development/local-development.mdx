...
Amazon Event Bridge events, emulating services like Amazon Cognito, SQS. So, it will not be possible to test Webiny with tools like LocalStack because Webiny does not work without AWS services.  
