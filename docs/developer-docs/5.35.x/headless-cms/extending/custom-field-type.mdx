...
4. Deploy the API changes, run the [`webiny watch`](/docs/{version}/core-development-concepts/basics/watch-command) command to start a new watch session on `apps/api/graphql` application code.
