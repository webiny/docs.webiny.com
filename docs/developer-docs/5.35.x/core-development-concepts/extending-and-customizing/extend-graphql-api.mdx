...
The [`CmsGraphQLSchemaPlugin`](https://github.com/webiny/webiny-js/blob/v5.35.0/packages/api-headless-cms/src/plugins/CmsGraphQLSchemaPlugin.ts) plugin is part of the [`@webiny/handler-graphql`](https://github.com/webiny/webiny-js/tree/v5.11.0/packages/handler-graphql) package, which can also be used to create new standalone GraphQL APIs.
