...
Use the [`webiny watch`](../../core-development-concepts/basics/watch-command) command to continuously deploy application code changes into the cloud and instantly see them in action. For quick (manual) testing, you can use the built-in [API Playground](/docs/{version}/admin-area/basics/api-playground/).
...
The [Extend GraphQL API](../../core-development-concepts/scaffolding/extend-graphql-api) and [Extend Admin Area](../../admin-area/new-app-tutorial/scaffolding) scaffolds, which can help you extend your GraphQL API in no time, use the same concepts and approaches that are explained in this guide.
...
Learn more about the [Headless CMS GraphQL API](../../headless-cms/basics/graphql-api).
...
To extend your default GraphQL API in no time, make sure to try the [Extend Admin Area](../../admin-area/new-app-tutorial/scaffolding) and [Extend GraphQL API](../../core-development-concepts/scaffolding/extend-graphql-api) scaffolds.
...
- [Page Builder](../../page-builder/extending/extend-graphql-api)
- [Headless CMS](../../headless-cms/extending/extend-graphql-api)
