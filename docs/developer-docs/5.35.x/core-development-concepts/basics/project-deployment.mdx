...
You can find more details about the development and deployment principals in this [article](/docs/{version}/core-development-concepts/development/local-development.mdx). 
