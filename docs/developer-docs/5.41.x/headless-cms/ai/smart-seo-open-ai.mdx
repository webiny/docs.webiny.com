...
<Alert type="info">
  ...
  In your real project, you can remove this content model by either [deleting the corresponding api directory](https://github.com/webiny/webiny-examples/tree/master/headless-cms/test-plugins-ai/5.41.x/extensions/testPluginsAi/api) or commenting out the [Article import in the index file](https://github.com/webiny/webiny-examples/blob/501128af39b463fd1645ac08e939ceed00f18a17/headless-cms/test-plugins-ai/5.41.x/extensions/testPluginsAi/api/src/index.ts#L4).
