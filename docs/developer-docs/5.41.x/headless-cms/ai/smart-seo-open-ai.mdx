...
```bash
WEBINY_ADMIN_OPEN_AI_API_KEY=sk-proj-T2-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
```
...
### Smart SEO
This is the [primary plugin (`SmartSeo.tsx`)](https://github.com/webiny/webiny-examples/blob/master/headless-cms/smart-seo-open-ai/5.41.x/extensions/smartSeoOpenAi/admin/src/SmartSeo.tsx  ) that integrates Webiny with OpenAI. It sends the HTML content to OpenAI and retrieves SEO-related information. The received data is then used to update the corresponding fields in the model.

If you’ve noticed the AI-Optimized SEO button on the Content Entry form, it has been configured in this plugin using the [ContentEntryEditorConfig](https://github.com/webiny/webiny-examples/blob/59f44c564e83e9c453819882209e8946b5069b79/headless-cms/smart-seo-open-ai/5.41.x/extensions/smartSeoOpenAi/admin/src/SmartSeo.tsx#L117).

<Alert type="info">

  We display the **AI-OPTIMIZED SEO** button on the Content Entry form for the content model with the ID `article`.
  You can easily customize it to include your [content model IDs](https://github.com/webiny/webiny-examples/blob/59f44c564e83e9c453819882209e8946b5069b79/headless-cms/smart-seo-open-ai/5.41.x/extensions/smartSeoOpenAi/admin/src/SmartSeo.tsx#L123) to display this button on the respective content model entry forms.
