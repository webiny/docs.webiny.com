...
If the data is still being loaded, the **Loading...** message is displayed. If the data is not found, the **No countries found.** message is displayed. Otherwise, the list of country names is displayed.
