...
[Click here](https://vscode.dev/redirect/mcp/install?name=webiny&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fmcp.docs.webiny.com%2Fmcp%22%7D) to add the Webiny MCP server to VSCode.
