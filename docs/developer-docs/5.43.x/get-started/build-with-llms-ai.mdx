...
[Click here](cursor://anysphere.cursor-deeplink/mcp/install?name=Webiny&config=eyJ1cmwiOiJodHRwczovL21jcC5kb2NzLndlYmlueS5jb20vbWNwIn0K) to add the Webiny MCP server to Cursor.
