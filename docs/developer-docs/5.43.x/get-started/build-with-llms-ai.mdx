...
- **Name**: Webiny Docs
- **URL**: `https://webiny-mcp-server.sven-f88.workers.dev/mcp`
...
[Click here](https://cursor.com/install-mcp?name=webiny&config=eyJ1cmwiOiJodHRwczovL3dlYmlueS1tY3Atc2VydmVyLnN2ZW4tZjg4LndvcmtlcnMuZGV2L21jcCJ9) to add the Webiny MCP server to Cursor.
...
[Click here](https://vscode.dev/redirect/mcp/install?name=webiny&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fwebiny-mcp-server.sven-f88.workers.dev%2Fmcp%22%7D) to add the Webiny MCP server to VSCode.
