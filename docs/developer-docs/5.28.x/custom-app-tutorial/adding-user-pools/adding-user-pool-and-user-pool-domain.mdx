...
In case you missed it, check out the [dev and prod Stacks](/docs/{version}/overview/features/security-overview/get-started#dev-and-prod-stacks) section.
...
If you had the [`webiny watch`](/docs/{version}/core-development-concepts/basics/watch-command) command up and running while making the shown changes, the new cloud infrastructure resources should have been deployed automatically for you:

![Automatic Re-deployment of Cloud Infrastructure](./assets/adding-user-pool-and-user-pool-domain/cloud-infra-auto-deploy.png)

If not, you can either start a new watch session, or simply deploy the changes via the [`webiny deploy`](/docs/{version}/core-development-concepts/basics/project-deployment) command.
