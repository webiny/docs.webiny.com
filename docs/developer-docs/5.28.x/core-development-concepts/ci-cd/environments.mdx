...
Check out the [Deploy Your Project](/docs/{version}/core-development-concepts/basics/project-deployment) guide to learn how to deploy your project into multiple environments.
...
Read more about how to organize cloud accounts in the [Cloud (AWS) Accounts](/docs/{version}/core-development-concepts/ci-cd/environments#cloud-aws-accounts) section.
...
This structure of environments is also mirrored by branches in your project's Git repository. More on this in the [Version Control](/docs/{version}/core-development-concepts/ci-cd/version-control) topic that follows.
...
Learn more about differences between the development and production cloud infrastructure differences in the [Cloud Infrastructure](/docs/{version}/architecture/introduction#different-cloud-infrastructure-setups) key topic.
