...
1. provide deployment secrets - AWS credentials and [Pulumi Backend](/docs/{version}/core-development-concepts/ci-cd/cloud-infrastructure-state-files#using-different-backends).
