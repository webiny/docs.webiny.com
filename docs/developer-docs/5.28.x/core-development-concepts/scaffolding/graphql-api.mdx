...
The **GraphQL API** scaffold creates a new standalone GraphQL HTTP API, which can be utilized by your frontend applications (for example, applications created with the [React Application](../../core-development-concepts/scaffolding/full-stack-application) scaffold). Once created, you can immediately deploy it into your cloud (AWS) account and continue further development with just a couple of [Webiny CLI](../../core-development-concepts/basics/webiny-cli) commands.
