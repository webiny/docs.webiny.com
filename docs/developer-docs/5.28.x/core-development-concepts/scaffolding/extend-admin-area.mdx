...
In order to do this, internally, the scaffold is simply utilizing the existing **Extend GraphQL API** scaffold. To learn more about its main features and how to continue developing on top of the application code it generates, please visit [its dedicated guide](../../admin-area/new-app-tutorial/extending-entities).
...
Luckily, with a couple of built-in utilities, this can be relatively easily added. Please check out the [existing tutorials](../../overview/features/security) to learn how to implement these on your own.
