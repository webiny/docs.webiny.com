...
<Alert type="success" title="What you'll learn">
  - We will cover the how to use Lexical Configuration API to customize the Lexical editor in Page
  Builder and Headless CMS apps.
</Alert>
...
<Alert type={"info"}>
  Prop <b>name</b> it as a required prop. Webiny has names for all configuration options. Please
  check the <b>Lexical Components Catalog</b> topic at the end of this article.
</Alert>
...
<Image title="Lexical editor in Headless CMS App" src={lexicalInHcms} style={{ width: 450 }} />
...
Use these **_Dropdown_** and **_DropdownItem_** components to create a dropdown for your toolbar. Use the **_Divider_** component to separate toolbar actions.
