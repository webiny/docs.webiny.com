...
import errorOverlay from "./5.7.0/error-overlay.png";
...
:::info How To Upgrade?
Please check the [Webiny 5.7.0 migration guide](/docs/how-to-guides/upgrade-webiny/5.6.0-to-5.7.0) for the upgrade steps.
:::
...
:::info
This change, requires some little tweaks to your existing projects. Find all the necessary instructions in the [Webiny 5.7.0 migration guide](/docs/how-to-guides/upgrade-webiny/5.6.0-to-5.7.0).
:::
