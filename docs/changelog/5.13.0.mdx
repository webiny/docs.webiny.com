...
- [New Full Stack Application](/docs/how-to-guides/webiny-cli/scaffolding/new-full-stack-application)
- [New GraphQL API](/docs/how-to-guides/webiny-cli/scaffolding/new-graphql-api)
- [New React Application](/docs/how-to-guides/webiny-cli/scaffolding/new-react-application)
...
:::note
Users who used the [Extend Admin Area](/docs/how-to-guides/webiny-cli/scaffolding/extend-admin-area) scaffold were the first to experience this issue, as the main-menu items that were created during the scaffolding process simply weren't clickable.
:::
