...
### Improved Deployment Process for the Website Project Application
...
Once successfully deployed, please note that it can take a couple of minutes for the website to be fully updated. This is mainly because of the Amazon Cloudfront and its caching settings.
