...
id: 5.11.1
title: Webiny 5.11.1
sidebar_label: "5.11.1"
keywords: ["webiny", "version", "5.11.1", "changelog"]
...
Please check the [Webiny 5.11.1 migration guide](/docs/how-to-guides/upgrade-webiny/5.11.0-to-5.11.1) for the upgrade steps.
