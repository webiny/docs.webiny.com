...
In addition to that, you can also use a fine-grained policy for the [CLI user](/docs/how-to-guides/deployment/aws/configure-aws-credentials/#attaching-a-fine-grain-policy), which is important for making secure deploys of your Webiny project.
