...
- while a search term is typed into the search bar's input, switching to a different content entries section via the main menu no longer causes an infinite redirect loop in the browser
