...
:::info Learn More
To learn more about the new `webiny watch` command, check out the newly added [Use the Watch Command](/docs/how-to-guides/webiny-cli/use-watch-command) guide.
:::
