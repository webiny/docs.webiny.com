...
:::info Learn More
To learn more about the new `webiny watch` command, check out the newly added [Use the Watch Command](/docs/how-to-guides/development/use-watch-command) guide.
:::
...
Note that, if upgrading to version `5.5.0`, there are a couple of [manual steps](/docs/how-to-guides/upgrade-webiny/5.4.0-to-5.5.0#additional-manual-upgrade-steps) that need to be done in order for these fixes to be fully applied.
