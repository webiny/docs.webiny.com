...
To address this issue, in the Headless CMS content model editor, a new form input was added to the settings section, allowing us to change the group if needed.
