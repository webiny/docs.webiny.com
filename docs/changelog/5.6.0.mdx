...
In our [previous release](/docs/changelog/5.5.0), we released the brand new [`webiny watch`](/docs/changelog/5.5.0#brand-new-webiny-watch-command-1540) command. But, we didn't stop there, so today, we're happy to introduce its first improvement.
