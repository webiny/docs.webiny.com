...
import scaffolds from "./5.9.0/scaffolds.gif";
...
<ChangelogSection title="Development" />

<ChangelogItem prNumber="1720" title="Improved Scaffolding" />
...
<ChangelogItem prNumber="1693" title="Improved AWS Lambda Function Bundling Error Output" />
