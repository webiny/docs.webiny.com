...
Make sure you didn't miss the **[5.11.1](/docs/changelog/5.11.1)** release, which was an urgent security hotfix! You **must** apply that upgrade before moving on to **5.12.0**. 
