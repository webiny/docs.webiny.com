...
| ------ | :-------------: | :---------------------------------: | -----------------------------: |
| Test A |       50        | t3.small.elasticsearch (single AZ)  | <!-- prettier-ignore -->$0.038 |
...
The test is configured by ramping up to the defined number of user threads within 60 second period. After the ramp up we keep a steady state where the maximum amount of user threads are doing requests as fast as the system can handle for a period of 10 minutes.
...
| ------ | ------------------------------: | ------------------------------: | ----------------------------: | ----------------------------: | ------------------------------: | ----------------------------: |
| Test A | <!-- prettier-ignore -->$0.0773 | <!-- prettier-ignore -->$0.0773 | <!-- prettier-ignore -->$0.26 | <!-- prettier-ignore -->$0.58 | <!-- prettier-ignore -->$0.0095 | <!-- prettier-ignore -->$0.99 |
...
| ------ | ----: | -----------: | ------------------------------: |
| Test A | 77.3k |         0.09 | <!-- prettier-ignore -->$0.0773 |
...
| Test   |  Hits |                            Cost |
| ------ | ----: | ------------------------------: |
| Test A | 77.3k | <!-- prettier-ignore -->$0.0773 |
| Test B |   000 |                             000 |
| Test C |   000 |                             000 |
